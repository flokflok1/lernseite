...
System(lsx, "LSX Lernsystem", "KI-gestützte Lernplattform mit 32 Lernmethoden")
...
|---------|-------------|
| **32 Lernmethoden** | LM00–LM31 in 4 Gruppen (A–D), von Deep Explanation bis Quest/XP |
...
note right of methods
  32 Lernmethoden (LM00–LM31):
  - Gruppe A: 8 (Erklärend)
  - Gruppe B: 10 (Praxis/Übung)
  - Gruppe C: 8 (Prüfungsorientiert)
  - Gruppe D: 6 (Pro/Gamification)
end note
...
| 💎 **Premium User** | Alle 32 Lernmethoden (LM00–LM31), KI-Zugriff | Private Gruppen |
...
> **Details:** Siehe [02_Lernmethoden.md](02_Lernmethoden.md) für die vollständige Spezifikation aller 32 Methoden.

```plantuml
@startuml
title Lernmethoden-Kategorisierung (32 Methoden)
...
**Gesamt: 32 Lernmethoden (8 + 10 + 8 + 6)**
...
| 7 | 🎯 **Lernmethoden-Generator** | 32 Methoden (LM00–LM31) befüllen |
...
| 📚 **Lernmethoden** | 32 Methoden (LM00–LM31) in 4 Gruppen (A–D) |
...
| 🎯 `02_Lernmethoden.md` | 32 Lernmethoden (LM00–LM31) – Master-Dokument |
