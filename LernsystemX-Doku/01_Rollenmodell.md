...
package "Premium Features" {
  component "Alle 32 Lernmethoden" as methods {
...
note right of methods
  Vollzugriff auf alle 32 Methoden
  (LM00–LM31, Gruppen A–D)
end note
...
| Kategorie | Details |
|-----------|---------|
| ✅ **Alle 32 Lernmethoden** | LM00–LM31, Gruppen A–D (Vollzugriff) |
...
| Kategorie | Details |
|-----------|---------|
| 🎨 **Kurserstellung** | Voller Zugriff auf alle 32 Methoden (LM00–LM31) |
