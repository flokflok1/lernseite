...
package "Content Access (32 Lernmethoden)" {
  [Gruppe A: Erklärend (LM00–LM07)] as basis
  [Gruppe B: Praxis/Übung (LM08–LM17)] as premium_methods
  [Gruppe C: Prüfungsorientiert (LM18–LM25)] as pruefung
  [Gruppe D: Pro/Gamification (LM26–LM31)] as pro
}
...
note right of premium_user
  Alle 32 Lernmethoden (LM00–LM31)
  KI-Vollzugriff
...
| 2 | Premium = Lernen auf höchstem Level (alle 32 Lernmethoden LM00–LM31 **konsumieren**) |
...
|----------|------|---------|---------|--------|--------|-------------|---------|-----|-------|
| **32 Methoden konsumieren** | ✅ Gruppe A+B teil | ✅ Alle (LM00–LM31) | ✅ Alle | ✅ Alle | ✅ Alle | ✅ Alle | ✅ Lesen | ✅ Lesen | ✅ Alle |
| **32 Methoden erstellen** | ❌ | 🔶 Privat | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ |
| **KI-Nutzung** | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ |
| **Gruppe D erstellen** | ❌ | ❌ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ |
| **Private Kurse** | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ |
| **Community-Kurse** | ❌ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ |
...
| Premium | Alle 32 Lernmethoden (LM00–LM31) |
| Creator/Teacher/School/Company | Alle 32 Lernmethoden |
| Support/Mod | Lesezugriff auf alle |
| Admin | Alle 32 Lernmethoden |
...
|-------|-------------------|
| Free | ❌ Keine |
| Premium | 🔶 Community & Private (keine Gruppe D-Methoden) |
| Creator | ✅ Alle (inkl. Gruppe D) + Verkauf |
| Teacher/School/Company | ✅ Alle (ohne Verkauf) |
| Support/Mod | ❌ Keine |
| Admin | ✅ Alle |
...
| Bereich | Zugriff |
|---------|---------|
| Lernmethoden | ✅ Alle 32 konsumieren (LM00–LM31) |
| KI | ✅ Vollzugriff |
| Kurserstellung | ✅ Community & Privat (keine Gruppe D-Methoden erstellen) |
...
| Bereich | Zugriff |
|---------|---------|
| Lernmethoden | ✅ Alle 32 erstellen & konsumieren (LM00–LM31) |
...
| Bereich | Zugriff |
|---------|---------|
| Lernmethoden | ✅ Alle 32 erstellen (LM00–LM31) |
...
## Zugriff auf die 32 Lernmethoden (LM00–LM31)
...
**Wichtig:** Premium darf Gruppe D-Methoden **konsumieren** aber **nicht erstellen**.
...
- **Premium-Power:** Alle 32 Methoden (LM00–LM31) konsumieren
