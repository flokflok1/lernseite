...
Container_Boundary(course_system, "Kurssystem") {
    ...
    Container(methods, "Lernmethoden", "32 Methoden (LM00–LM31)", "Interaktive Übungen & Tests")
...
| **Lernmethoden** | 0-32 interaktive Methoden (LM00–LM31, siehe [02_Lernmethoden.md](02_Lernmethoden.md)) | Optional |
...
| ✅ **Methoden-Flexibilität** | Jedes Modul KANN 0-32 Lernmethoden (LM00–LM31) enthalten |
...
Ein Modul kann **0 bis 32 Lernmethoden** enthalten. Jede Methode ist eine Instanz eines der 32 Methodentypen (LM00–LM31, definiert in [02_Lernmethoden.md](02_Lernmethoden.md)).
...
| `method_type` | INTEGER | Methodentyp (0-31, entspricht LM00–LM31) |
...
package "Editor-Features" {
  ...
  rectangle "Basis-Features" #LightGreen {
    ...
    [Gruppe A+B: Grundlegende Methoden (LM00–LM17)]
  }
...
| **Flexibilität** | 0-32 Methoden pro Modul (LM00–LM31) |
