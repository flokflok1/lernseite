...
Das LSX-Premium-Modell bietet Nutzern maximalen Lernnutzen durch Zugang zu allen 32 Lernmethoden (LM00–LM31), KI-gestützten Features und erweiterten Kollaborationsfunktionen. Es ist die zentrale Einnahmequelle der Plattform und muss klar definiert, fair, skalierbar, wertvoll und transparent gestaltet sein.
...
System_Ext(learning, "Lern-System", "32 Methoden (LM00–LM31)")
...
Rel(premium_system, learning, "Schaltet alle 32 Methoden frei")
...
|------------|------------|-------------|---------------------|
| **Azubis** | IHK-Prüfungsvorbereitung | Alle 32 Methoden (LM00–LM31), KI-Prüfungssimulation | FIAE, FISI, Kaufmännische Berufe |
...
| **Quereinsteiger** | Karrierewechsel | Gruppe D-Methoden konsumieren, KI-Support | IT-Umschulung, neue Branchen |
...
Container_Boundary(premium_features, "Premium Features") {
  Component(learning_methods, "32 Lernmethoden (LM00–LM31)", "Vue.js", "Voller Zugang")
...
|----------|------|---------|-----------------|
| **Lernmethoden** | Gruppe A+B teilweise | Alle 32 (LM00–LM31) | +Gruppe C+D komplett |
...
| **Lernmethoden** | Alle 32 Methoden (LM00–LM31) |
...
- **Wertvoll:** Alle 32 Methoden (LM00–LM31) + KI rechtfertigen Preis
