...
note right of creator
  ✅ Alle 32 Methoden erstellen (LM00–LM31)
  ✅ Gruppe D-Methoden (LM26–LM31)
  ✅ Global Publishing
  ✅ 75% Revenue Share
  ✅ Creator-Analytics
  ✅ 20.000 Tokens/Monat
...
System_Boundary(creator_system, "Creator System") {
  ...
  Container(course_editor, "Advanced Course Editor", "Vue.js", "32 Methoden (LM00–LM31) + Pro-Features")
...
Container_Boundary(creator_features, "Creator Features") {
  Component(course_editor, "Advanced Course Editor", "Vue.js", "32 Methoden (LM00–LM31) + Pro")
...
| **Methoden** | Alle 32 (LM00–LM31, inkl. Gruppe D) |
...
| **Lernmethoden** | Alle 32 (LM00–LM31, inkl. Gruppe D erstellen) |
