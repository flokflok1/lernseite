...
package "Phase 6: Seeds & Abschluss" #LightGray {
    [32 Lernmethoden (LM00–LM31)] as methods
    [Kategorien] as cats
    [Rollen] as roles
    [Branding] as brand
}
...
class SeedData:
    ...
    def _seed_learning_methods() -> int:
        """Seed 32 learning methods (LM00–LM31)"""
        from backend.models import LearningMethod
        from backend.database import db

        # 32 Lernmethoden gemäß 02_Lernmethoden.md
...
| **Seeds** | ✓ | 32 Methoden (LM00–LM31), Rollen, Kategorien |
...
• Admin-Setup mit 2FA
• KI-Pipeline-Konfiguration
• Seed-Daten (32 Methoden LM00–LM31, Kategorien, Rollen)
