...
- GET /api/v1/admin/ai/jobs - List all jobs
- GET /api/v1/admin/ai/jobs/<id> - Get job details
- PUT /api/v1/admin/ai/jobs/<id>/cancel - Cancel job
- DELETE /api/v1/admin/ai/jobs/<id> - Delete job
