"""
LernsystemX Chapter Theory CRUD - List and Get Operations

User-facing endpoints for reading chapter theories:
...
# Blueprint for list/get operations
chapter_theory_list_get_bp = Blueprint(
    'chapter_theory_list_get',
    __name__,
    url_prefix=''
)


@chapter_theory_list_get_bp.route('/chapters/<chapter_id>/theories', methods=['GET'])
@token_required
...
@chapter_theory_list_get_bp.route('/chapters/<chapter_id>/theory', methods=['GET'])
@token_required
@limiter.limit("30 per minute")
...
@chapter_theory_list_get_bp.route('/chapter-theory/<theory_id>', methods=['GET'])
@token_required
