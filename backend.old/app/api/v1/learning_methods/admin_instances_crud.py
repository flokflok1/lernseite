...
from app.api.v1.learning_methods.services import MethodValidationService, MethodEnrichmentService
from app.api.v1.learning_methods.value_objects import MethodStatus

# Blueprint for learning method instances CRUD
lm_instances_bp = Blueprint(
    'learning_methods_instances',
    __name__,
    url_prefix='/api/v1'
)
