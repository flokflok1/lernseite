...
@profile_core_bp.route('', methods=['GET'])
@token_required
def get_profile():
    """
...
@profile_core_bp.route('', methods=['PUT'])
@token_required
def update_profile():
    """
...
@profile_core_bp.route('/change-password', methods=['POST'])
@token_required
def change_password():
    """
...
@profile_core_bp.route('', methods=['DELETE'])
@token_required
def delete_profile():
    """
