"""
Categories Domain - CRUD Routes (Admin Journey)
...
ISO 27001:2013 compliant - Category management
"""
...
def create_category():
    ...
    Request Body:
        {
            ...
            "level": 3,  // 1-20 (practical limit, DB allows 1-5)
    ...
    Notes:
        ...
        - Level auto-calculated from parent if not provided
        - order_index auto-assigned if not provided
    """
    try:
...
def update_category(category_id: int):
    ...
    Note: Cannot update level or parent_id to prevent breaking hierarchy.
          Use move endpoint (/categories/:id/move) to change parent.
...
def delete_category(category_id: int):
    ...
    Response:
        ...
        {
            "success": true,
            "message": "Kategorie und 5 Unterkategorie(n) erfolgreich gelöscht",
            "deleted_categories": 6
        }
    ...
    Notes:
        ...
        - Fails if ANY category in tree has courses
