...
from src.repositories.ai.studio import (
    AIStudioRepository,
    AIStudioAnalyticsRepository
)
from src.repositories.courses.chapters import ChapterRepository
from src.repositories.courses.lessons import LessonRepository
from src.repositories.learning_method.instances import LearningMethodInstanceRepository
from src.services.ai_studio.utils import AiStudioServiceError

logger = logging.getLogger(__name__)


class AiStudioFinalizer:
    """
    Session finalizer for AI Studio.
    ...
    def finalize_session(
        ...
        if create_methods and created_chapter:
            AiStudioFinalizer._create_methods(
