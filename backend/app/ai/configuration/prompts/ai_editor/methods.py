"""
LernsystemX KI - AI Editor Methods Step Prompt
...
AI_EDITOR_METHODS_PROMPT = """Generiere Methoden-Varianten für jede Lektion.
...
def init_methods_prompt() -> None:
    ...
    ai_editor_methods = PromptTemplate(
        code="ai_editor_methods",
        ...
        version=1,
        tags=["ai-editor", "authoring", "methods", "variants"],
        messages=[
            PromptMessage(
                role="system",
            ...
            PromptMessage(
                role="user",
                content=AI_EDITOR_METHODS_PROMPT
            )
        ],
        variables=[
    ...
    register_prompt(ai_editor_methods)
