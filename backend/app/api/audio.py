"""
Audio API - Speech-to-Text (STT) and Real-time Audio Processing

Provides endpoints for:
- Whisper STT (Speech-to-Text)
- Real-time audio transcription
- Audio processing for LM24 (Oral Explanation) and other voice-based methods
"""
...
@api_v1.route('/audio/transcribe', methods=['POST'])
@token_required
...
@api_v1.route('/audio/transcribe-base64', methods=['POST'])
@token_required
...
@api_v1.route('/audio/analyze-oral', methods=['POST'])
@token_required
...
@api_v1.route('/audio/supported-formats', methods=['GET'])
