...
@api_v1.route('/dashboard/layout', methods=['GET'])
@token_required
...
@api_v1.route('/dashboard/layout', methods=['PUT'])
@token_required
def save_dashboard_layout():
    ...
    try:
        ...
        saved_layout = DashboardService.save_layout(user, layout)
...
@api_v1.route('/dashboard/layout/reset', methods=['POST'])
@token_required
