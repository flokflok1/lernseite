...
- GET    /api/v1/subscriptions/stats - Get subscription statistics (admin only)
...
@api_v1.route('/subscriptions/plans', methods=['GET'])
...
@api_v1.route('/subscriptions/me', methods=['GET'])
@token_required
...
@api_v1.route('/subscriptions/change', methods=['POST'])
@token_required
...
@api_v1.route('/subscriptions/cancel', methods=['POST'])
@token_required
...
@api_v1.route('/subscriptions/reactivate', methods=['POST'])
@token_required
...
@api_v1.route('/subscriptions/stats', methods=['GET'])
@token_required
@admin_required
...
@api_v1.route('/subscriptions/expiring', methods=['GET'])
@token_required
@admin_required
