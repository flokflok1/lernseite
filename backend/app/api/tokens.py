...
- GET    /api/v1/tokens/stats - Get token statistics (admin only)
...
# ============================================================================
# AUTHENTICATED TOKEN ENDPOINTS
# ============================================================================

@api_v1.route('/tokens/me', methods=['GET'])
@token_required
...
@api_v1.route('/tokens/transactions', methods=['GET'])
@token_required
...
@api_v1.route('/tokens/usage', methods=['GET'])
@token_required
def get_my_usage():
    """
...
# ============================================================================
# ORGANISATION TOKEN ENDPOINTS
# ============================================================================

@api_v1.route('/tokens/organisation/<int:organisation_id>', methods=['GET'])
@token_required
...
@api_v1.route('/tokens/manual-topup', methods=['POST'])
@token_required
@admin_required
def manual_topup():
    """
...
@api_v1.route('/tokens/stats', methods=['GET'])
@token_required
@admin_required
def get_token_stats():
    """
...
@api_v1.route('/tokens/estimate', methods=['POST'])
@token_required
