...
- POST /api/v1/admin/ai/models/sync/<provider_id> - Sync models from provider
...
# DDD Core Domain
from app.api.v1.admin.ai.core.factory import AIModelFactory
from app.api.v1.admin.ai.core.services import AISyncService
from app.api.v1.admin.ai.core.events import (
    AIModelSyncedEvent,
    EventPublisher,
    EventPriority
)
