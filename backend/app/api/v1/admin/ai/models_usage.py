...
- GET /api/v1/admin/ai/models/<id>/usage - Get usage stats for specific model
- GET /api/v1/admin/ai/models/usage - Get usage stats for all models
...
# DDD Core Domain
from app.api.v1.admin.ai.core.services import AIUsageService
