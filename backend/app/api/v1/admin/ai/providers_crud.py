...
- GET    /api/v1/admin/ai/providers/<id> - Get provider by ID
- POST   /api/v1/admin/ai/providers - Create provider (uses Factory)
...
# DDD Core Domain
from app.api.v1.admin.ai.core.factory import AIProviderFactory
