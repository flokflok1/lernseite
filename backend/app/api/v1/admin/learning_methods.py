...
Endpoint:
- GET /admin-panel/learning-methods/{code}/schema - Get UI schema for learning method
...
bp = Blueprint(
    ...
    __name__,
    url_prefix='/admin-panel/learning-methods'
)
...
def get_learning_method_schema(code: int) -> Tuple[Dict[str, Any], int]:
    ...
    Examples:
        GET /api/v1/admin-panel/learning-methods/0/schema
        -> Returns UI schema for lm00 (Tiefgehende Erklärung)

        GET /api/v1/admin-panel/learning-methods/5/schema
