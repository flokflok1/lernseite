...
Endpoints:
- GET /admin/permissions/thresholds - List all thresholds
- PUT /admin/permissions/thresholds/<key> - Update threshold
...
# Create blueprint
permission_thresholds_bp = Blueprint('permission_thresholds', __name__, url_prefix='/admin/permissions')
