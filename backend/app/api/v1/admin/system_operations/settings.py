...
@api_v1.route('/admin/system/mode', methods=['POST'])
@token_required
@admin_required
...
@api_v1.route('/admin/system/maintenance', methods=['POST'])
@token_required
@admin_required
...
@api_v1.route('/admin/system/status', methods=['GET'])
@token_required
@admin_required
...
@api_v1.route('/admin/system/settings', methods=['GET'])
@token_required
@admin_required
...
@api_v1.route('/admin/system/settings/<key>', methods=['GET'])
@token_required
@admin_required
...
@api_v1.route('/admin/system/settings/<key>', methods=['PATCH'])
@token_required
@admin_required
