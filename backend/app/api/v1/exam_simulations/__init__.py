...
from app.api.v1.exam_simulations.user.core import core_bp, course_bp
from app.api.v1.exam_simulations.user.attempts import attempts_bp
from app.api.v1.exam_simulations.user.settings import settings_bp
