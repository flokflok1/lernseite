...
from app.api.v1.math_toolkit.admin.routes import admin_bp
from app.api.v1.math_toolkit.user.practice import practice_bp
from app.api.v1.math_toolkit.user.reference import reference_bp
from app.api.v1.math_toolkit.user.tasks import tasks_bp
