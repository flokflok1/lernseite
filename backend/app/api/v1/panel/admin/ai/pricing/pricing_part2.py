...
Endpoints for pricing plan CRUD and cost analysis:
...
Uses:
- PlanRepository for plan persistence
- AuditService for change tracking
- DDD approach for domain logic

See also: pricing.py for pricing calculator endpoints.
"""
...
pricing_plans_bp = Blueprint(
    'ai_pricing_plans',
    __name__,
    url_prefix='/panel/settings/ai/pricing/plans'
)
