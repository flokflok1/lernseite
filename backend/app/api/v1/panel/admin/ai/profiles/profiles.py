...
from app.infrastructure.persistence.repositories.ai.config.profiles import AiModelProfilesRepository as AIProfileRepository
...
profiles_crud_bp = Blueprint(
    'ai_profiles_crud',
    __name__,
    url_prefix='/panel/settings/ai/profiles'
)
