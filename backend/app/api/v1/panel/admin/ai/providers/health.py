...
- GET /api/v1/admin/settings/ai/providers/<id>/health - Get current health status
- GET /api/v1/admin/settings/ai/providers/<id>/health/history - Get health history
- GET /api/v1/admin/settings/ai/providers/health - Get health overview for all providers
