...
Full admin system dashboard views with comprehensive analytics.

Endpoints:
    - GET /dashboard/admin/system/overview - System overview stats
    - GET /dashboard/admin/system/activity - Recent activity
    - GET /dashboard/admin/system/users - User statistics
    - GET /dashboard/admin/system/courses - Course statistics
    - GET /dashboard/admin/system/ai-usage - AI usage statistics

Permissions: Admin only
ISO 27001:2013 compliant - Admin analytics

Moved from: api/v1/dashboard/admin_system.py → api/v1/dashboard/admin/system/
