"""
LernsystemX Organisations API - Member Management

Organisation Members:
- GET /organisations/<id>/users - List organisation users
- POST /organisations/<id>/assign-user - Assign user to organisation

Continuation of core.py (split for Quality Gate G01: max 500 lines per file)
...
from app.api.v1.panel.admin.organisations.core import (
    organisations_bp,
