...
- POST /panel/tutor/generate-chapter-theory - Generate chapter theory sheet
- POST /panel/tutor/generate-lesson-steps - Generate step-by-step lesson
- POST /panel/tutor/generate-lesson-detailed - Generate detailed lesson explanation
...
# Blueprint
tutor_admin_bp = Blueprint('tutor_admin', __name__, url_prefix='/panel/tutor')
