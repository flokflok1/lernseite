...
from flask import current_app, request, g, make_response, Response
...
def _create_sunset_response(warning: DeprecationWarning) -> Response:
    """
    ...
    Returns:
        Response: Flask response with 410 status
    """
...
def _add_deprecation_headers(response: Any, warning: DeprecationWarning) -> Any:
    """
    ...
    Returns:
        Any: Response with deprecation headers
    """
...
def _log_deprecated_usage(endpoint: str, warning: DeprecationWarning) -> None:
    """
