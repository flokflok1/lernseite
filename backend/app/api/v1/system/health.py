...
def health_check() -> tuple:
    ...
    Returns:
        tuple: Response with basic health status (200 OK or 503 Service Unavailable)
...
def health_check_detailed() -> tuple:
    """
    Detailed health check endpoint

    Returns:
        tuple: Response with detailed component status
...
def readiness_check() -> tuple:
    ...
    Returns:
        tuple: Response with readiness status (200 or 503)
    """
...
def liveness_check() -> tuple:
    ...
    Returns:
        tuple: Response with liveness status (200 or 503)
    """
