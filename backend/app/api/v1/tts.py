"""
LernsystemX TTS API - Consolidated
...
@tts_bp.route('/speak-stream', methods=['POST'])
@token_required
...
@tts_bp.route('/tutor-script', methods=['POST'])
@token_required
...
@tts_bp.route('/pronunciations', methods=['GET'])
...
@tts_bp.route('/pronunciations', methods=['POST'])
@token_required
...
@tts_bp.route('/pronunciations/ai', methods=['POST'])
@token_required
