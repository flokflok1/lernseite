...
class AIEditorSessionCreateRequest(BaseModel):
    """
    Create new AI authoring session

    Example:
        >>> request = AIEditorSessionCreateRequest(
        ...     course_id="uuid",
...
class AIEditorSessionUpdateRequest(BaseModel):
    """Update session data"""
...
class AIEditorSourceDataRequest(BaseModel):
...
class AIEditorGenerateRequest(BaseModel):
    """
    Request AI content generation

    Example:
        >>> request = AIEditorGenerateRequest(
        ...     content_type="theory",
...
class AIEditorSelectVariantRequest(BaseModel):
...
class AIEditorRateVariantRequest(BaseModel):
...
class AIEditorFinalizeRequest(BaseModel):
    """
    Finalize session and create chapter

    Example:
        >>> request = AIEditorFinalizeRequest(
        ...     create_chapter=True,
        ...     create_lessons=True,
        ...     create_methods=True,
...
class AIEditorSnapshotRequest(BaseModel):
...
class AIEditorSessionResponse(BaseModel):
    """
...
class AIEditorSessionListItem(BaseModel):
...
class AIEditorVariantResponse(BaseModel):
...
class AIEditorSnapshotResponse(BaseModel):
...
class AIEditorPDFUploadResponse(BaseModel):
    """PDF upload response"""
    file_hash: str
...
class AIEditorStatsResponse(BaseModel):
...
class AIEditorProgressEvent(BaseModel):
