"""
LernsystemX AI Editor Repository
...
class AIEditorRepository:
    ...
    def find_by_id(cls, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        query = """
            ...
            LEFT JOIN courses.courses c ON s.course_id = c.course_id
            LEFT JOIN courses.chapters ch ON s.chapter_id = ch.chapter_id
...
class AIEditorAnalyticsRepository:
    """Repository for AI Editor analytics events"""

    table_name = 'ai_editor_analytics'
    ...
    def get_session_events(cls, session_id: str) -> List[Dict[str, Any]]:
        ...
        query = "SELECT * FROM ai_editor_analytics WHERE session_id = %s ORDER BY created_at DESC"
        return fetch_all(query, (session_id,))
