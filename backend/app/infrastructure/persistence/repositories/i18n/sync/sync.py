...
- sync_repository.py - Sync history operations (I18nSyncRepository)
- sync_repository_part2.py - Sync details, snapshots & statistics (I18nSyncDetailsMixin)
- sync_ops.py - Sync operations (SyncOpsRepository, SyncOperation, etc.)
- sync_changes.py - Change detection (SyncChangesRepository, SyncChange, etc.)
- sync_resolutions.py - Resolution management (SyncResolutionsRepository, etc.)

Implements Repository Pattern with direct SQL + psycopg3 (NO ORM).
"""

# Import main repository (includes mixin from sync_repository_part2)
