...
This package provides backward-compatible bridge for existing imports:
    ...
    # Maps to: from app.infrastructure.persistence.repositories.knowledge import KnowledgeRepository
...
from app.infrastructure.persistence.repositories.knowledge.search import KnowledgeRepositorySearch
from app.infrastructure.persistence.repositories.knowledge.learning import KnowledgeRepositoryLearning
from app.infrastructure.persistence.repositories.knowledge.query_log import KnowledgeRepositoryQueryLog
from app.infrastructure.persistence.repositories.knowledge.cache import KnowledgeRepositoryCache
