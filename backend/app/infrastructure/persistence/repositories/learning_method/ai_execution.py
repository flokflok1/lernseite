...
- _build_method_prompt: Generate method-specific prompts (in ai_execution_part2.py)
...
Prompt building methods are in ai_execution_part2.py (LearningMethodAIPromptsMixin).
"""
...
class LearningMethodAIRepository(LearningMethodAIPromptsMixin):
    """
    AI execution for learning methods with token tracking and cost analysis.

    Prompt building methods inherited from LearningMethodAIPromptsMixin
    (ai_execution_part2.py).
    """
