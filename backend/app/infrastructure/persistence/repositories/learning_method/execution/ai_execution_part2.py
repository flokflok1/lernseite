...
Lektionsinhalt:
{content if content else 'Bezugskalkulation und kaufmännisches Rechnen'}
...
{content if content else 'Keine spezifischen Inhalte verfügbar'}"""
...
Lektionsinhalt:
{content if content else 'Kaufmännische Inhalte'}"""
...
Lektionsinhalt:
{content if content else 'Erstelle eine passende Aufgabe basierend auf dem Lektionsthema.'}
