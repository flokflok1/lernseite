...
Handles organisation-level database operations including:
- Organisation CRUD operations
- Organisation listing with pagination
- Organisation statistics

User-organisation membership and token operations are in core_part2.py.
...
class OrganisationRepository(OrganisationUsersMixin, BaseRepository):
    """
    ...
    User-organisation membership methods are provided via OrganisationUsersMixin.
    """
