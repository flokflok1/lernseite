...
class MigrationManager:
    ...
    # Execution methods (run_migration, run_pending_migrations,
    # _ensure_migration_history_table) are defined in migrations_part2.py
    # and attached to this class via __init__.py barrel export.
