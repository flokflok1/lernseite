-- ============================================================================
-- Migration: 091_permission_thresholds.sql
-- Description: Permission Thresholds System (RBAC 2.0)
--              Flexible permission system with configurable hierarchy thresholds
--              Allows admin panel to control access levels dynamically
-- Version: 1.0.0
-- Author: LernsystemX Migration System
-- Date: 2026-01-16
-- ============================================================================
-- Previous number: 069 (Root) → Renumbered to 091 to resolve duplicates
