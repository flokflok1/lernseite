...
-- Description: Learning Methods Instance Table
-- Version: 2.1.0
-- Author: LernsystemX Migration System
-- Date: 2025-01-17
-- Updated: 2025-12 (19 Content-LMs, System-Features separat)
-- ============================================================================

-- ============================================================================
-- TABLE: learning_methods
-- Description: Learning method instances
-- Content-LMs: 19 Methoden in Gruppen A-C (0-3, 6, 8, 12-15, 17-25)
...
COMMENT ON TABLE learning_methods IS '19 Content-Lernmethoden: Gruppe A (0-3,6), B (8,12-15,17), C (18-25). System-Features separat.';
COMMENT ON COLUMN learning_methods.method_type IS 'Content-LM IDs: 0,1,2,3,6,8,12,13,14,15,17,18-25. Constraint 0-31 für Abwärtskompatibilität.';
COMMENT ON COLUMN learning_methods.data IS 'JSONB structure varies by method_type';
COMMENT ON COLUMN learning_methods.tier IS 'basic (Gruppe A+B), premium (Gruppe C)';
