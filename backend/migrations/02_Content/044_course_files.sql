-- ============================================================================
-- Migration: 044_course_files.sql
...
CREATE TABLE IF NOT EXISTS courses.course_files (
    ...
    file_id UUID,  -- Foreign key to billing_storage.media_files(file_id) - added in 08_Storage migrations
...
-- ============================================================================
-- End of Migration: 044_course_files.sql
-- ============================================================================
