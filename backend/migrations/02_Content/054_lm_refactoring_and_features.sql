...
-- ============================================================================
-- TEIL 1: CourseFeatures Tabelle
-- ============================================================================
-- NOTE: course_features table is created in 069_system_features_tables.sql
-- with normalized schema (course_id, feature_type_id, config JSONB)
-- ============================================================================
...
-- NOTE: tutor_sessions table is created in 069_system_features_tables.sql
-- with feature-based schema (feature_type_id, persona_config, session_state)
...
-- ============================================================================
-- NOTE: v_course_with_features removed - course_features schema changed in 069
-- Use direct queries on course_features + system_feature_types instead
...
-- ============================================================================
--
-- HINWEIS: Diese Migration ist historisch. Aktuell: 19 Content-LMs (siehe 062)
-- AKTIVE Content-LMs:
--
