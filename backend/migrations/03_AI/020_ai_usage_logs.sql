...
CREATE INDEX IF NOT EXISTS idx_ki_requests_org ON ai_pipeline.ki_requests(organisation_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_ai_usage_agg_org ON ai_pipeline.ai_usage_aggregates(organisation_id, date DESC);
