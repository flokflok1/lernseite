...
-- ============================================================================
-- TABLE: pdf_cache (DEFERRED TO 08_Storage)
-- Description: Cached PDF analysis results for reuse
-- NOTE: This table is created in storage schema which hasn't been created yet.
--       Deferred to 08_Storage/031_media_files.sql to avoid forward references
-- ============================================================================
-- DO NOT UNCOMMENT - This is moved to 08_Storage migrations
--
