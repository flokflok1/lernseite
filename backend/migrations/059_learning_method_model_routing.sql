...
-- Mapping Learning Methods (LM00-LM32) to AI Models
...
CREATE TABLE IF NOT EXISTS learning_method_model_assignments (
    ...
    -- Learning Method ID (0-32, corresponds to LM00-LM32)
...
-- Comments
COMMENT ON TABLE learning_method_model_assignments IS 'Maps Learning Methods (LM00-LM32) to AI Models with hierarchical scope support';
COMMENT ON COLUMN learning_method_model_assignments.learning_method_id IS 'Learning Method ID (0-32, corresponds to LM00-LM32)';
...
-- ============================================================================
-- INSERT: Default requirements for all 33 Learning Methods
...
VALUES ('059_learning_method_model_routing', '1.0.0', 'success')
