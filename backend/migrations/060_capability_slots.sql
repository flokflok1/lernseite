...
CREATE TABLE IF NOT EXISTS lm_slot_requirements (
    ...
    -- Learning Method ID (0-32 = LM00-LM32)
    ...
    -- Constraints
    CONSTRAINT chk_lm_slot_req_lm_id CHECK (learning_method_id >= 0 AND learning_method_id <= 32),
...
-- ============================================================================
-- SEED: LM Slot Requirements for all 33 Learning Methods
-- Based on LernsystemX-Doku/36_LM-KI-Capabilities-Matrix.md
-- ============================================================================
...
INSERT INTO lm_slot_requirements (learning_method_id, slot_id, is_required, is_primary, usage_description) VALUES
    ...
    -- LM07: NPC-Tutor-Lecture (braucht Realtime!)
...
INSERT INTO lm_slot_requirements (learning_method_id, slot_id, is_required, is_primary, usage_description) VALUES
    -- LM08: Whiteboard-Aufgabe (braucht Vision!)
    ...
    -- LM12: Mathe-Interaktiv (braucht Vision für Handschrift!)
...
INSERT INTO lm_slot_requirements (learning_method_id, slot_id, is_required, is_primary, usage_description) VALUES
    ...
    -- LM24: Mündliche Erklärung (braucht STT und TTS!)
...
INSERT INTO lm_slot_requirements (learning_method_id, slot_id, is_required, is_primary, usage_description) VALUES
    ...
    -- LM29: Sokratischer Dialog (braucht Reasoning + Realtime!)
    ...
    -- LM30: Spaced Repetition
    (30, get_slot_id('chat'), TRUE, TRUE, 'Wiederholungs-Content'),

    -- LM31: Quest/XP System
    (31, get_slot_id('chat'), TRUE, TRUE, 'Quest-Beschreibungen'),

    -- LM32: Vokabeltrainer (braucht TTS für Aussprache!)
    (32, get_slot_id('chat'), TRUE, TRUE, 'Vokabeln und Beispiele'),
    (32, get_slot_id('tts'), FALSE, FALSE, 'Aussprache'),
    (32, get_slot_id('stt'), FALSE, FALSE, 'Aussprache prüfen')
ON CONFLICT (learning_method_id, slot_id) DO UPDATE SET
    is_required = EXCLUDED.is_required,
    is_primary = EXCLUDED.is_primary,
    usage_description = EXCLUDED.usage_description,
...
CREATE TABLE IF NOT EXISTS lm_slot_assignments (
    ...
    -- Constraints
    CONSTRAINT chk_lm_slot_assign_lm_id CHECK (learning_method_id >= 0 AND learning_method_id <= 32),
...
INSERT INTO migration_history (migration_name, version, status)
VALUES ('060_capability_slots', '1.0.0', 'success')
