...
CREATE INDEX IF NOT EXISTS idx_subscriptions_org ON billing_storage.subscriptions(organisation_id);
...
CREATE INDEX IF NOT EXISTS idx_payment_methods_org ON billing_storage.payment_methods(organisation_id);
