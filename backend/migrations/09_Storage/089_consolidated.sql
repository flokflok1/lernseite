...
-- - Domain taxonomy (8 initial domains) → 00_Seeds/15_agent_intelligence_domains.sql
--
...
DO $$
BEGIN
    RAISE NOTICE 'Migration 094_agent_global_knowledge.sql completed successfully';
    ...
    RAISE NOTICE 'Seed data: 8 initial knowledge domains (see 00_Seeds/15_agent_intelligence_domains.sql)';
    RAISE NOTICE '';
