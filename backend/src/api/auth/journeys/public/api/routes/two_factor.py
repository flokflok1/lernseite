"""
Auth Domain - Two-Factor Authentication Routes (Public Journey)
...
def disable_2fa():
    ...
    try:
        ...
        # Verify password
        user_obj = AuthRepository.find_user_by_email(user['email'])
        if not user_obj or not AuthRepository.verify_password(
