"""
Organisations Domain - Reports Routes (Analytics Journey)

Top reports endpoints:
- GET /organisations/<org_id>/analytics/top-courses
- GET /organisations/<org_id>/analytics/top-modules
...
from ._helpers import (
    request, jsonify,
    datetime,
    OrgTopCoursesResponse, OrgTopCourseAnalytics,
    OrgTopModulesResponse, OrgTopModuleAnalytics,
    AnalyticsRepository,
