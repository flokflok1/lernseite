"""
Users Domain - CRUD Routes (User Journey)
...
def create_user():
    ...
    try:
        ...
        # Create user via UserService (includes EventBus publish)
        user_dict = UserService.create_user(
...
@users_crud_bp.route('/users/<user_id>', methods=['DELETE'])
@admin_required
def delete_user(user_id: str):
    ...
    try:
        ...
        # Soft delete via UserService (includes EventBus publish)
