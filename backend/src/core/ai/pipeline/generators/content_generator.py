"""
AI Studio Generation Module

Handles content generation for AI Studio wizard steps.
...
from src.ki.prompt_registry import get_prompt_template, PromptRegistryError
from src.services.ai_adapter import AIAdapter, AIProviderError
from src.repositories.ai.studio import (
    AIStudioRepository,
    AIStudioAnalyticsRepository
)
from src.services.ai_studio.utils import (
...
class AiStudioGenerator:
    ...
    def __init__(self, provider: str = "anthropic", model: str = "claude-3-5-sonnet-20241022"):
        """
        Initialize AI Studio Generator.
