...
// import { ttsApi } from '@/infrastructure/api/clients/system'
// TODO: Implement ttsApi in @/infrastructure/api/clients/learning domain
...
export function useTeachingTimeline() {
  ...
  async function executeSpeech(text: string): Promise<void> {
    ...
    try {
      ...
      // TODO: Implement ttsApi.speak() API call in @/infrastructure/api/clients/learning domain
      // Stub response for now - using estimated timing based on text length
