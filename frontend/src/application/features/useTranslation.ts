...
import { getBundle, type LanguageProgress } from '@/infrastructure/api/clients/system'
...
export function useTranslation() {
  ...
  async function fetchLanguages(): Promise<LanguageProgress[]> {
    ...
    // NOTE: getLanguages() API not yet implemented - using fallback from available locales
    ...
    languagesCache.value = fallbackLanguages
