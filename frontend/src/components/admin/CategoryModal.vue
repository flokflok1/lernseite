      ...
      <form @submit.prevent="handleSubmit" class="modal-body">
        ...
        <div class="form-group">
          <label class="form-label">
            Name *
            <span class="text-xs text-[var(--color-text-secondary)]">(wird angezeigt)</span>
          </label>
          <input
            ...
            required
            class="form-input"
            placeholder="z.B. Programmierung, Webentwicklung"
            maxlength="100"
          />
        </div>
        ...
        <div class="form-group">
          <label class="form-label">
            Slug *
            <span class="text-xs text-[var(--color-text-secondary)]">(URL-freundlicher Name)</span>
          </label>
          <input
        ...
        <div class="form-group">
          <label class="form-label">
            ...
            <span class="text-xs text-[var(--color-text-secondary)]">(optional - für Hierarchie)</span>
          </label>
          <select v-model="formData.parent_id" class="form-input">
            ...
            >
              ...
              <span v-if="cat.level >= 20">(Max. Tiefe erreicht)</span>
            </option>
          </select>
          <p class="text-xs text-[var(--color-text-secondary)] mt-1">
            Aktuelles Level: {{ currentLevel }} (max. 20)
          </p>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="form-group">
            <label class="form-label">
              Icon
              <span class="text-xs text-[var(--color-text-secondary)]">(Emoji)</span>
            </label>
            <input
        ...
        <div class="form-group">
          <label class="form-label">
            Reihenfolge
            <span class="text-xs text-[var(--color-text-secondary)]">(niedrigere Zahl = weiter oben)</span>
          </label>
          <input
        ...
        <div class="form-group">
          <label class="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span class="form-label mb-0">Kategorie ist aktiv</span>
          </label>
