...
import type { LsxWindow, WindowType } from '@/store/modules/desktop'
import PreviewCourseCreate from '@/components/base/system/shared/previews/PreviewCourseCreate.vue'
import PreviewCourseEditor from '@/components/base/system/shared/previews/PreviewCourseEditor.vue'
import PreviewKapitelEditor from '@/components/base/system/shared/previews/PreviewKapitelEditor.vue'
import PreviewLessonEditor from '@/components/base/system/shared/previews/PreviewLessonEditor.vue'
import PreviewAIJob from '@/components/base/system/shared/previews/PreviewAIJob.vue'
