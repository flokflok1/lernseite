...
const LearningMethodFormComponents: Record<number, ReturnType<typeof defineAsyncComponent>> = {
  0: defineAsyncComponent(() => import('@/components/base/content/admin/learning-methods/forms/LearningMethod00Form.vue')),
  1: defineAsyncComponent(() => import('@/components/base/content/admin/learning-methods/forms/LearningMethod01Form.vue')),
  2: defineAsyncComponent(() => import('@/components/base/content/admin/learning-methods/forms/LearningMethod02Form.vue')),
  3: defineAsyncComponent(() => import('@/components/base/content/admin/learning-methods/forms/LearningMethod03Form.vue')),
  4: defineAsyncComponent(() => import('@/components/base/content/admin/learning-methods/forms/LearningMethod04Form.vue')),
  5: defineAsyncComponent(() => import('@/components/base/content/admin/learning-methods/forms/LearningMethod05Form.vue')),
  6: defineAsyncComponent(() => import('@/components/base/content/admin/learning-methods/forms/LearningMethod06Form.vue')),
  7: defineAsyncComponent(() => import('@/components/base/content/admin/learning-methods/forms/LearningMethod07Form.vue')),
  8: defineAsyncComponent(() => import('@/components/base/content/admin/learning-methods/forms/LearningMethod08Form.vue')),
  9: defineAsyncComponent(() => import('@/components/base/content/admin/learning-methods/forms/LearningMethod09Form.vue')),
  10: defineAsyncComponent(() => import('@/components/base/content/admin/learning-methods/forms/LearningMethod10Form.vue')),
