<template>
  <div class="chapter-theory-section">
    ...
    <div v-if="loading" class="loading-state">
      ...
      <p>Theorie wird generiert...</p>
      <p class="loading-hint">Dies kann 10-30 Sekunden dauern.</p>
    </div>
    ...
    <div v-else-if="!hasTheory" class="no-theory-state">
      ...
      <p class="info-text">
        Die Theorie wird einmal generiert und gespeichert.
        Du kannst sie jederzeit wieder anschauen.
      </p>
      ...
      <div class="theory-layout">
        ...
        <div class="whiteboard-section">
          <div class="whiteboard-header">
            ...
            <span>Interaktives Whiteboard</span>
          </div>
          ...
          <div class="tts-controls">
            ...
            <div class="voice-select">
              ...
              <select v-model="selectedVoice">
                ...
                <option value="fable">Fable (erzahlend)</option>
        ...
        <div class="text-section">
          ...
          <div v-if="theoryContent.concepts?.length" class="theory-block concepts">
            <h3><span class="block-icon">&#128218;</span> Kernkonzepte</h3>
            <div class="concepts-grid">
              ...
              >
                ...
                <p v-if="concept.example" class="concept-example">
                  <strong>Beispiel:</strong> {{ concept.example }}
                </p>
          ...
          <div v-if="theoryContent.terms?.length" class="theory-block terms">
            <h3><span class="block-icon">&#128214;</span> Wichtige Begriffe</h3>
          ...
          <div v-if="theoryContent.examTips?.length" class="theory-block exam-tips">
            <h3><span class="block-icon">&#128293;</span> Prufungstipps</h3>
            <ul class="tips-list">
          ...
          <div v-if="theoryContent.summary" class="theory-block summary">
            <h3><span class="block-icon">&#128221;</span> Zusammenfassung</h3>
