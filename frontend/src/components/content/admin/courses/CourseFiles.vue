...
<template>
  <div class="admin-course-files-window h-full flex flex-col bg-white dark:bg-gray-900">
    <!-- Header -->
...
const courseTitle = computed(() => props.window.payload?.courseTitle as string || t('common.course'))
