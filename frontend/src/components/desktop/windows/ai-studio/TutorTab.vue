...
<template>
  <div class="tutor-tab">
    ...
    <div v-if="!chapter && !lesson" class="empty-state">
      ...
      <p>
        Wähle links ein <strong>Kapitel</strong> für das Theorieblatt
        oder eine <strong>Lektion</strong> für die Schritt-für-Schritt Erklärung.
      </p>
    </div>
...
import ChapterTheoryView from './tutor/ChapterTheoryView.vue'
import LessonExplanationView from './tutor/LessonExplanationView.vue'
