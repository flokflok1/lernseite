  ...
  <div v-if="context" class="workflow-panel">
    ...
    <div class="context-header">
      ...
      <div class="context-details">
        <span class="context-type">{{ context.type === 'chapter' ? 'Kapitel' : 'Lektion' }}</span>
        <span class="context-title">{{ context.title }}</span>
      </div>
      <button @click="$emit('close')" class="context-close" title="Kontext schließen">×</button>
    </div>
    ...
    <div class="workflow-section analyze-section">
      <div class="workflow-header">
        ...
        <span v-if="selectedFileCount" class="workflow-badge">{{ selectedFileCount }} Dateien</span>
      </div>
      <button
        @click="$emit('analyze')"
      ...
      >
        ...
        <span v-else-if="selectedFileCount">🔍 Mit {{ selectedFileCount }} Datei(en) analysieren</span>
    ...
    <div class="workflow-section theory-section">
      ...
      <div v-else-if="context.type === 'chapter'" class="theory-content-list">
        ...
        >
          ...
          <span v-else>{{ theories.length ? '➕ Weitere Zusammenfassung' : '📚 Zusammenfassung erstellen' }}</span>
        </button>
      </div>
      ...
      <div v-else class="theory-content-list">
        ...
        >
          <span v-if="isGeneratingTheory">⏳ Generiere...</span>
          <span v-else>{{ explanations.length ? '➕ Weiteres Theorieblatt' : '📖 Theorieblatt erstellen' }}</span>
        </button>
      </div>
    </div>
    ...
    <div v-if="context.type === 'lesson'" class="workflow-section lm-section">
      <div class="workflow-header">
        ...
        <span v-if="isLoadingLMSuggestions" class="workflow-badge">Analysiere...</span>
      </div>
