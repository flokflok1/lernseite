    ...
    <div class="main-layout">
      ...
      <div class="list-panel">
        <div class="panel-header">
          ...
          <span class="panel-title">Theorieblätter</span>
          <button @click="loadTheories" class="refresh-btn" title="Aktualisieren">🔄</button>
        </div>
        ...
        <div v-else class="content-list">
          ...
          >
            ...
            <div class="item-actions">
              <button v-if="theory.audioUrl" @click.stop="playAudio(theory.audioUrl)" class="item-btn" title="Audio abspielen">
                🔊
              </button>
              <button @click.stop="onDeleteTheory(theory.theoryId)" class="item-btn danger" title="Löschen">🗑️</button>
            </div>
          </div>
        </div>
      ...
      <div class="detail-panel">
        <div class="panel-header">
          ...
          <span class="panel-title">{{ showCreateForm ? 'Neues Theorieblatt' : 'Vorschau' }}</span>
        </div>
        ...
        <div v-if="showCreateForm" class="create-form">
          <div class="form-section">
            ...
            <input v-model="newTitle" type="text" class="form-input" placeholder="Automatisch generiert" />
          </div>
          ...
          <div class="form-section">
            ...
            <select v-model="selectedStyle" class="form-select">
              ...
              <option value="exam">📝 Prüfungsfokus</option>
            </select>
          </div>
          ...
          >
            ...
            <span v-else>✨ Theorieblatt generieren</span>
          </button>
        ...
        <div v-else class="no-selection">
          ...
          <p>Wähle ein Theorieblatt aus oder erstelle ein neues</p>
        </div>
      </div>
          ...
          <div class="settings-section">
            ...
            <div class="setting-row">
              ...
              <select v-model="tts.selectedModel.value" class="setting-select">
                <option value="browser">Browser TTS (kostenlos)</option>
...
async function onDeleteTheory(theoryId: string) {
  if (!confirm('Möchtest du dieses Theorieblatt wirklich löschen?')) return
...
async function generateNewTheory() {
  ...
  try {
    ...
    localError.value = err.response?.data?.error?.message || err.message || 'Fehler bei der Generierung'
  } finally {
