  ...
  <div class="feature-flags-analytics">
    ...
    <div class="metrics-grid">
      <div class="metric-card">
        ...
        <div class="metric-label">{{ $t('admin.featureFlags.totalFlags') }}</div>
      ...
      <div class="metric-card">
        ...
        <div class="metric-label">{{ $t('admin.featureFlags.enabledCount') }}</div>
        <div class="metric-bar">
          <div
            class="bar-fill"
      ...
      <div class="metric-card">
        ...
        <div class="metric-label">{{ $t('admin.featureFlags.disabledCount') }}</div>
        <div class="metric-bar">
          <div
            class="bar-fill"
      ...
      <div class="metric-card">
        ...
        <div class="metric-label">{{ $t('admin.featureFlags.activeRollouts') }}</div>
        <div class="metric-bar">
          <div
            class="bar-fill"
    ...
    <div class="category-section">
      <h3>{{ $t('admin.featureFlags.byCategory') }}</h3>
      <div class="category-list">
        <div v-for="(flags, category) in flagsByCategory" :key="category" class="category-item">
          <div class="category-header">
            <span class="category-name">{{ category }}</span>
            <span class="category-count">{{ flags.length }} {{ $t('admin.featureFlags.flags') }}</span>
          </div>
          ...
          <div class="category-stats">
            <span class="stat">{{ getEnabledCount(flags) }} {{ $t('admin.featureFlags.enabled') }}</span>
            <span class="stat">{{ getDisabledCount(flags) }} {{ $t('admin.featureFlags.disabled') }}</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="rollout-section" v-if="plans.length > 0">
      <h3>{{ $t('admin.featureFlags.rolloutProgress') }}</h3>
    ...
    <div v-if="totalFlags === 0" class="empty-state">
      <p>{{ $t('admin.featureFlags.noAnalyticsData') }}</p>
    </div>
  </div>
</template>
