  ...
  <div class="ai-lesson">
    <div class="lesson-intro">
      <div class="intro-header">
        ...
        <div>
          <h3 class="intro-title">Interaktive Lektion</h3>
          <p class="intro-subtitle">Nutze die Aufgaben im rechten Panel</p>
        </div>
      </div>

      <!-- Topic (for interactive lessons) -->
      <div v-if="content.topic" class="topic-card">
        <h4 class="topic-label">Thema</h4>
      ...
      <div v-if="hasInteractiveContent" class="info-grid">
        ...
        <div v-if="content.pruefungs_relevanz" class="info-card info-card--primary">
          ...
          <p class="info-label">Relevanz</p>
        </div>
      </div>

      <!-- Hint -->
      <div v-if="content.hinweis" class="hint-card">
        <h4 class="hint-label">Hinweis</h4>
        <p class="hint-text">{{ content.hinweis }}</p>
      </div>

      <!-- Instructions -->
      <div class="instructions-card">
        <h4 class="instructions-title">Aufgaben zur Lektion</h4>
        <p class="instructions-text">
          Im rechten Panel findest du interaktive Aufgaben, die dir helfen, den Inhalt zu üben:
        </p>

        <ul class="instructions-list">
          <li>
            <span class="list-arrow">→</span>
            <span>Klicke auf eine Aufgabe, um sie zu starten</span>
          </li>
          <li>
            <span class="list-arrow">→</span>
            <span>Bearbeite die Übungen im eigenen Tempo</span>
          </li>
          <li>
            <span class="list-arrow">→</span>
            <span>Erhalte sofortiges Feedback zu deinen Antworten</span>
          </li>
        </ul>

        <div class="token-hint">
          <p>
            <strong>Hinweis:</strong> Für Aufgaben werden Tokens verbraucht. Dein aktuelles Token-Guthaben wird im Panel angezeigt.
          </p>
        </div>
      </div>
      ...
      <div v-if="content.learning_context" class="context-card">
        <h4 class="context-label">Lernkontext</h4>
      ...
      <div v-if="content.example_prompts && content.example_prompts.length > 0" class="prompts-section">
        <h4 class="prompts-title">Beispiel-Prompts</h4>
