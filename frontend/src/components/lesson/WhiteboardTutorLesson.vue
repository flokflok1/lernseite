        ...
        <div class="chalkboard-container">
          ...
          <div class="chalkboard-frame">
            ...
            <div class="chalkboard-surface">
              ...
              <h2 class="chalk-title">{{ currentTitle || 'Bezugskalkulation' }}</h2>
              <!-- Content area -->
    ...
    <Transition name="fade">
      <div v-if="showCelebration" class="celebration">
        <div class="celebration-content">
          ...
          <h2>Super gemacht!</h2>
          <p>Du hast die Lektion abgeschlossen.</p>
          <button @click="onComplete" class="btn-complete">Weiter</button>
        </div>
      </div>
    </Transition>
  </div>
...
import OnScreenCalculator from '@/components/tutor/OnScreenCalculator.vue'
import RealisticTeacher3D from '@/components/tutor/RealisticTeacher3D.vue'
import {
  useTeachingTimeline,
  type TeachingStep,
...
const currentTitle = ref('Bezugskalkulation')
...
// ============================================================================
const avatarName = ref('Herr Schmidt')
