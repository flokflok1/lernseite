<template>
  <div class="postcard">
    <div class="coming-soon-container">
      ...
      <p class="component-name">PostCard</p>
      <p class="description">Display individual post with content and metadata</p>
    </div>
  </div>
</template>
...
/**
 * PostCard Component (Stub)
 * Display individual post with content and metadata
 * 
