...
<template>
  <div class="section provider-section">
    <div class="section-header">
      <h3 class="section-title">{{ $t('windows.aiStudioGlobalSettings.providerApiKeys') }}</h3>
    </div>
    <div class="provider-grid">
      ...
      >
        ...
        <div class="provider-info">
          ...
          <span class="provider-meta">{{ getModelCount(provider.name) }} {{ $t('windows.aiStudioGlobalSettings.models') }}</span>
        </div>
