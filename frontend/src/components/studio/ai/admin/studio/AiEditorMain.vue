  ...
  <div class="ai-editor-main">
    ...
    <div class="tabs-bar">
      ...
      >
        ...
        <span class="tab-label">{{ $t('features.aiEditorPro.chat') }}</span>
        <svg
          class="chat-chevron"
...
/**
 * AiEditorMain - Main orchestrator for AI Studio
 */
...
import CourseAuthoringSidebar from './kurs-builder/CourseAuthoringSidebar.vue'
...
const studioState = useAiEditorState()
...
onMounted(async () => {
  ...
  const courseId = props.panel.payload?.courseId
...
watch(() => props.panel.payload?.courseId, (newCourseId) => {
