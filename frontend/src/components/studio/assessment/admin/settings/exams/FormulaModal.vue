  ...
  >
    <div class="bg-[var(--color-surface)] rounded-xl p-6 w-[600px] max-h-[80vh] overflow-y-auto">
      <h3 class="text-lg font-semibold text-[var(--color-text-primary)] mb-4">
        {{ $t('windows.aiStudioAssets.formulaModal.title') }}
      </h3>
      ...
      <div class="space-y-4">
        ...
        <div>
          <label class="text-sm text-[var(--color-text-secondary)] mb-1 block">
            {{ $t('windows.aiStudioAssets.formulaModal.latexCode') }}
          </label>
          <textarea
            :value="modelValue"
            ...
            :placeholder="$t('windows.aiStudioAssets.formulaModal.latexPlaceholder')"
          ></textarea>
        </div>
        ...
        <div>
          <label class="text-sm text-[var(--color-text-secondary)] mb-1 block">
            {{ $t('windows.aiStudioAssets.formulaModal.preview') }}
          </label>
        ...
        <div>
          <label class="text-sm text-[var(--color-text-secondary)] mb-2 block">
            {{ $t('windows.aiStudioAssets.formulaModal.commonFormulas') }}
          </label>
