...
const sendMessage = async () => {
  ...
  try {
    ...
    tutorStore.addMessage('tutor', 'Entschuldigung, es gab einen Fehler. Bitte versuche es erneut.')
  } finally {
    ...
    >
      ...
      >
        ...
        <div v-if="showSettings" class="p-4 bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-600 max-h-48 overflow-y-auto">
          <h4 class="font-medium text-gray-900 dark:text-white mb-3">Einstellungen</h4>

          <!-- Personality Selection -->
          <div class="mb-4">
            <label class="block text-sm text-gray-600 dark:text-gray-300 mb-2">Persönlichkeit</label>
          ...
          <!-- Custom Personality -->
          <div class="mb-4">
            <label class="block text-sm text-gray-600 dark:text-gray-300 mb-2">Eigene Beschreibung</label>
            <textarea
              v-model="tutorStore.settings.customPersonalityText"
              @change="tutorStore.saveSettings()"
              placeholder="z.B. Sei witzig und erkläre alles mit Fußball-Metaphern..."
          ...
          <div class="flex items-center justify-between mb-2">
            <span class="text-sm text-gray-600 dark:text-gray-300">Sprachausgabe</span>
            <button
          ...
          <div v-if="tutorStore.settings.ttsEnabled" class="flex items-center justify-between">
            <span class="text-sm text-gray-600 dark:text-gray-300">Automatisch vorlesen</span>
            <button
