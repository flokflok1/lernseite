...
import type { DashboardLayout } from '@/domain/models/dashboard/widgets.types'
 ...
 * Re-exported from domain — canonical definition lives in domain/models/user/types.ts
 */
export type { UserGroup } from '@/domain/models/user/types'
