  ...
  <div class="p-6">
    ...
    <div class="max-w-2xl mx-auto">
      <div class="bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl p-8 text-white text-center">
        ...
        <h1 class="text-3xl font-bold mb-3">KI-Studio Pro</h1>
        <p class="text-white/80 mb-6 max-w-md mx-auto">
          Dein All-in-One Tool für KI-gestützte Kurserstellung.
          Generiere Videos, verwalte Prompts und konfiguriere Modelle.
        </p>
        ...
        <div class="grid grid-cols-3 gap-4 mt-8 text-sm">
          <div class="bg-white/10 rounded-xl p-4">
            ...
            <p class="text-white/60 text-xs mt-1">Sora 2 Video-Generator</p>
          </div>
          <div class="bg-white/10 rounded-xl p-4">
            <span class="text-2xl mb-2 block">📝</span>
            <span class="font-medium">Prompts</span>
            <p class="text-white/60 text-xs mt-1">System-Prompts verwalten</p>
          </div>
          <div class="bg-white/10 rounded-xl p-4">
            <span class="text-2xl mb-2 block">⚙️</span>
            <span class="font-medium">Modelle</span>
            <p class="text-white/60 text-xs mt-1">KI-Modelle konfigurieren</p>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-4 gap-4 mt-6">
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
          ...
          <div class="text-sm text-gray-500">Videos generiert</div>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
          <div class="text-2xl font-bold text-gray-900 dark:text-white">
            <span v-if="loading" class="animate-pulse">--</span>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
          ...
          <div class="text-sm text-gray-500">Tokens (Monat)</div>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
          ...
          <div class="text-sm text-gray-500">Kosten (Monat)</div>
        </div>
      </div>
    </div>
  </div>
