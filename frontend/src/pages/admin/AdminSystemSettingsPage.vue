<template>
  <div class="admin-system-settings min-h-screen bg-[#0a0e1a] p-6">
    <!-- Page Header -->
        ...
        <div class="flex gap-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-white mb-2">
              {{ $t('admin.systemSettings.help.title') }}
            </h3>
            <ul class="space-y-2 text-sm text-gray-300">
              <li class="flex items-start gap-2">
                <span class="text-primary-400 mt-1">•</span>
                <span>{{ $t('admin.systemSettings.help.point1') }}</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-primary-400 mt-1">•</span>
                <span>{{ $t('admin.systemSettings.help.point2') }}</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-primary-400 mt-1">•</span>
                <span>{{ $t('admin.systemSettings.help.point3') }}</span>
              </li>
              <li class="flex items-start gap-2">
                <span class="text-primary-400 mt-1">•</span>
                <span>{{ $t('admin.systemSettings.help.point4') }}</span>
              </li>
            </ul>
          </div>
        </div>
...
// Sub-components
import { SystemInfoWidget, SystemModeManager, MaintenanceModeToggle } from '@/components/admin/system-operations/settings'
...
const tabs = computed(() => [
  {
    id: 'info' as TabId,
    label: 'admin.systemSettings.tabs.info',
    icon: InfoIcon
  },
  {
    id: 'mode' as TabId,
    label: 'admin.systemSettings.tabs.mode',
    icon: SettingsIcon
  },
  {
    id: 'maintenance' as TabId,
    label: 'admin.systemSettings.tabs.maintenance',
    icon: ToolIcon
  }
])
</script>
