...
import type { LsxWindow, WindowType } from '@/application/stores/modules/desktop'
import PreviewCourseCreate from '@/presentation/components/base/system/shared/previews/PreviewCourseCreate.vue'
import PreviewCourseEditor from '@/presentation/components/base/system/shared/previews/PreviewCourseEditor.vue'
import PreviewKapitelEditor from '@/presentation/components/base/system/shared/previews/PreviewKapitelEditor.vue'
import PreviewLessonEditor from '@/presentation/components/base/system/shared/previews/PreviewLessonEditor.vue'
import PreviewAIJob from '@/presentation/components/base/system/shared/previews/PreviewAIJob.vue'
