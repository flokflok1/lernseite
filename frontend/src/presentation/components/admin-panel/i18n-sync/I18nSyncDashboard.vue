    ...
    <div class="dashboard-header">
      <div class="header-content">
        <div class="header-title">
          <h1>{{ $t('admin.i18n.title') }}</h1>
          <p class="subtitle">{{ $t('admin.i18n.subtitle') }}</p>
        </div>
        ...
        <div class="mode-selector">
          ...
          >
            ...
            <span class="mode-label">{{ $t('admin.i18n.mode_manual') }}</span>
            <span class="mode-desc">{{ $t('admin.i18n.mode_manual_desc') }}</span>
          </button>
          ...
          >
            ...
            <span class="mode-label">{{ $t('admin.i18n.mode_auto') }}</span>
            <span class="mode-desc">{{ $t('admin.i18n.mode_auto_desc') }}</span>
          </button>
        </div>
      </div>
      ...
      <div class="language-selector">
        <label class="label">{{ $t('admin.i18n.languages') }}</label>
        ...
        <div v-if="activeTab === 'dashboard'" class="tab-pane active">
          ...
          <div v-else-if="dashboardStats" class="dashboard-grid">
            ...
            <div class="stat-card">
              ...
              <div class="stat-label">{{ $t('admin.i18n.total_syncs') }}</div>
            </div>

            <!-- Successful Syncs -->
            <div class="stat-card success">
              <div class="stat-value">{{ dashboardStats.successful_syncs }}</div>
              <div class="stat-label">{{ $t('admin.i18n.successful_syncs') }}</div>
            </div>

            <!-- Failed Syncs -->
            <div class="stat-card error">
              <div class="stat-value">{{ dashboardStats.failed_syncs }}</div>
              <div class="stat-label">{{ $t('admin.i18n.failed_syncs') }}</div>
            </div>

            <!-- Pending Resolutions -->
            <div class="stat-card warning">
              <div class="stat-value">{{ dashboardStats.pending_resolutions }}</div>
              <div class="stat-label">{{ $t('admin.i18n.pending_resolutions') }}</div>
            </div>
