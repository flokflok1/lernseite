...
const buttons = computed(() => [
  {
    id: 'manual',
    label: t('admin.courseEditor.modes.manual'),
    description: t('admin.courseEditor.modes.manualDesc'),
    icon: '✏️',
    enabled: canAccessEditors.value
  },
  {
    id: 'ai',
    label: t('admin.courseEditor.modes.ai'),
    description: t('admin.courseEditor.modes.aiDesc'),
    icon: '🤖',
    enabled: canAccessEditors.value
  }
])
    ...
    >
      ...
      <div class="mb-6">
        ...
        <p class="text-gray-600 text-sm mt-2">
          {{ t('admin.courseEditor.selectModeDesc') }}
        </p>
      </div>
      ...
      <div v-if="!canAccessEditors" class="bg-yellow-50 border border-yellow-200 rounded p-4 mb-6">
        <p class="text-yellow-800 text-sm">
          {{ t('admin.courseEditor.permissionDenied') }}
        </p>
      </div>
      ...
      <div v-else class="mb-6">
        <p class="text-gray-700">
          {{ t('admin.courseEditor.contactAdmin') }}
        </p>
      </div>
