...
const tabs = computed(() => {
  const allTabs = [
    { id: 'courses', label: t('admin.courses.title'), icon: 'book' },
    { id: 'community', label: t('admin.community.title'), icon: 'users', badge: 3 },
    { id: 'academy', label: t('admin.academy.title'), icon: 'star' },
    { id: 'lm', label: t('admin.learningMethods.title'), icon: 'settings' }
  ]
...
<template>
  <div class="content-management">
    ...
    <div class="content-header">
      <h1>{{ $t('admin.contentManagement.title') }}</h1>
      <p class="content-header__subtitle">{{ $t('admin.contentManagement.subtitle') }}</p>
    </div>
