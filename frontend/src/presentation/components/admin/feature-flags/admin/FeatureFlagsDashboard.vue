<template>
  <div class="feature-flags-dashboard">
    ...
    <div class="dashboard-header">
      <div>
        <h1 class="dashboard-title">{{ $t('admin.featureFlags.title') }}</h1>
        <p class="dashboard-subtitle">{{ $t('admin.featureFlags.subtitle') }}</p>
      </div>
...
const tabs = computed(() => [
  {
    id: 'flags',
    label: t('admin.featureFlags.flags'),
    badge: store.totalFlags
  },
  {
    id: 'rollouts',
    label: t('admin.featureFlags.rolloutPlans'),
    badge: store.rolloutPlans.length
  },
  {
    id: 'analytics',
    label: t('admin.featureFlags.analytics')
  }
])
