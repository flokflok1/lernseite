...
/**
 * Admin Roles Management Content (RBAC 2.0)
 * =========================================
...
import { getSystemFeatures, getPermissions } from '@/infrastructure/api/clients/admin'
import type { RoleWithStats, SystemFeature, Permission, CreateRoleRequest, CreateFromTemplateRequest } from '@/infrastructure/api/clients/admin'
import { RoleList, RoleForm, PermissionMatrix, RoleTemplateSelector } from '@/presentation/components/base/admin-ui/user-management/roles'
