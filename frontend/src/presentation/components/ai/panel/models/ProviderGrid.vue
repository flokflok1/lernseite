...
<template>
  <div class="section provider-section">
    <div class="section-header">
      <h3 class="section-title">{{ $t('aiEditorGlobalSettings.providerApiKeys') }}</h3>
    </div>
    <div class="provider-grid">
      ...
      >
        ...
        <div class="provider-info">
          ...
          <span class="provider-meta">{{ getModelCount(provider.name) }} {{ $t('aiEditorGlobalSettings.models') }}</span>
        </div>
