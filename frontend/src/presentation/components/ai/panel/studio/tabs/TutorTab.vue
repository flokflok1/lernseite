...
import { ChapterTheoryView } from '@/presentation/components/system-features/tutor/admin/chapter-theory'
import { LessonExplanationView } from '@/presentation/components/system-features/tutor/admin/lesson-explanation'
