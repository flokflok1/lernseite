...
<template>
  <div class="tutor-tab">
    ...
    <div v-if="!chapter && !lesson" class="empty-state">
      ...
      <h3>{{ $t('windows.aiStudioTutor.selectContent') }}</h3>
      <p v-html="$t('windows.aiStudioTutor.selectContentHint')"></p>
    </div>
...
import { ChapterTheoryView } from '@/presentation/components/system-features/tutor/panel/chapter-theory'
import { LessonExplanationView } from '@/presentation/components/system-features/tutor/panel/lesson-explanation'
