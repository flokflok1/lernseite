  ...
  <div class="ai-studio-header">
    ...
    <div class="header-left">
      ...
      <div class="title-area">
        <h2 class="title">{{ $t('panel.aiStudio.title') }}</h2>
        <p class="subtitle">{{ selectedCourseTitle || $t('panel.aiStudio.selectCourse') }}</p>
      </div>
    </div>
    ...
    <div class="header-right">
      ...
      <!-- Quick Stats -->
      <div class="stats">
        <span class="stats-label">{{ $t('panel.aiStudio.lessons') }}:</span>
