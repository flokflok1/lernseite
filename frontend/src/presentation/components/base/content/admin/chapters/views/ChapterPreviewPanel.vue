  ...
  <div class="chapter-preview-panel">
    ...
    <div class="preview-header">
      <div class="chapter-badge">
        ...
        <span class="badge-label">Kapitel</span>
      </div>
      <h1 class="chapter-title">{{ chapter?.title || 'Unbekanntes Kapitel' }}</h1>
      <button class="close-btn" @click="$emit('close')" title="Schließen">×</button>
    </div>
    ...
    <div class="preview-content">
      ...
      <div class="lessons-section">
        <h3>📋 Lektionen in diesem Kapitel</h3>
            ...
            <div class="lesson-content">
              ...
              <div class="lesson-meta">
                <span v-if="lesson.methods?.length" class="meta-item methods">
                  ...
                  {{ lesson.methods.length }} Lernmethode{{ lesson.methods.length !== 1 ? 'n' : '' }}
                </span>
        ...
        <div v-else class="no-lessons">
          ...
          <p class="empty-hint">Lektionen werden im KI-Studio erstellt</p>
        </div>
      </div>

      <!-- Learning Methods Overview -->
      <div v-if="uniqueMethods.length > 0" class="methods-overview">
        <h3>🎯 Verwendete Lernmethoden</h3>
    ...
    <div class="preview-footer">
      <div class="footer-info">
        <span class="info-item">
          Erstellt: {{ formatDate(chapter?.created_at) }}
        </span>
      </div>
