    ...
    <div class="relative z-10 px-4 md:px-8 pb-2 flex justify-center">
      <div class="grid grid-cols-4 md:grid-cols-8 gap-1.5 w-full max-w-4xl">
        ...
        >
          ...
          <p class="text-[10px] font-medium text-gray-600 dark:text-gray-300">{{ $t('admin.courseDetail.stats.chapters') }}</p>
        </div>
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-lg p-2.5 shadow-md hover:shadow-lg transition-all group flex flex-col items-center border border-gray-100 dark:border-gray-700">
          ...
          <p class="text-[10px] font-medium text-gray-600 dark:text-gray-300">{{ $t('admin.courseDetail.stats.lessons') }}</p>
        </div>
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-lg p-2.5 shadow-md hover:shadow-lg transition-all group flex flex-col items-center border border-gray-100 dark:border-gray-700">
          ...
          <p class="text-[10px] font-medium text-gray-600 dark:text-gray-300">{{ $t('admin.courseDetail.stats.enrollments') }}</p>
        </div>
        ...
        >
          ...
          <p class="text-[10px] font-medium text-gray-600 dark:text-gray-300">{{ $t('admin.courseDetail.stats.files') }}</p>
        </div>
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-lg p-2.5 shadow-md hover:shadow-lg transition-all group flex flex-col items-center border border-gray-100 dark:border-gray-700">
          ...
          <p class="text-[10px] font-medium text-gray-600 dark:text-gray-300">{{ $t('admin.courseDetail.stats.revenue') }}</p>
        </div>
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-lg p-2.5 shadow-md hover:shadow-lg transition-all group flex flex-col items-center border border-gray-100 dark:border-gray-700">
          ...
          <p class="text-[10px] font-medium text-gray-600 dark:text-gray-300">{{ $t('admin.courseDetail.stats.rating') }}</p>
        </div>
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-lg p-2.5 shadow-md hover:shadow-lg transition-all group flex flex-col items-center border border-gray-100 dark:border-gray-700">
          ...
          <p class="text-[10px] font-medium text-gray-600 dark:text-gray-300">{{ $t('admin.courseDetail.stats.completionRate') }}</p>
        </div>
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-lg p-2.5 shadow-md hover:shadow-lg transition-all group flex flex-col items-center border border-gray-100 dark:border-gray-700">
          ...
          <p class="text-base font-bold text-gray-900 dark:text-white">{{ course.price ? `${course.price}€` : $t('admin.courseDetail.free') }}</p>
          <p class="text-[10px] font-medium text-gray-600 dark:text-gray-300">{{ $t('admin.courseDetail.stats.price') }}</p>
        </div>
      </div>
    </div>
  </div>
 ...
 */
import type { AdminCourseDetail } from '@/infrastructure/api/clients/admin'
