...
const AdminKapitelEditorPanel = defineAsyncComponent(() => import('@/presentation/components/base/content/admin/chapters/views/KapitelEditorPanel.vue'))
const AdminKapitelManagerPanel = defineAsyncComponent(() => import('@/presentation/components/base/content/admin/chapters/views/KapitelManagerPanel.vue'))
const AdminChapterPreviewPanel = defineAsyncComponent(() => import('@/presentation/components/base/content/admin/chapters/views/ChapterPreviewPanel.vue'))

// Content Management - Lessons
const AdminLessonEditorPanel = defineAsyncComponent(() => import('@/presentation/components/base/content/admin/lessons/views/LessonEditorPanel.vue'))
const AdminLessonPreviewPanel = defineAsyncComponent(() => import('@/presentation/components/base/content/admin/lessons/views/LessonPreviewPanel.vue'))

// Content Management - Learning Methods
const AdminLearningMethodEditorPanel = defineAsyncComponent(() => import('@/presentation/components/base/content/admin/learning-methods/views/LearningMethodEditorPanel.vue'))
