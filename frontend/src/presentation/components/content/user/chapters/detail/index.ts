...
// Re-exports from base/content/user/chapters/detail/ (DDD migration)
...
// Composables
export { useChapterDetail } from '../../../../base/content/user/chapters/detail/composables/useChapterDetail.ts'
