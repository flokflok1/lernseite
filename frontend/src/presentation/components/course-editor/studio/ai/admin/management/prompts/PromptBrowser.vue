...
<template>
  <div class="admin-prompt-browser-panel flex flex-col h-full">
    <!-- Header -->
...
const courseTitle = computed(() => props.panel.payload?.courseTitle as string | undefined)
const selectionMode = computed(() => props.panel.payload?.mode === 'select')
...
const confirmSelection = (): void => {
  if (selectedPrompt.value) {
    ...
    // Also dispatch a global event for cross-panel communication
