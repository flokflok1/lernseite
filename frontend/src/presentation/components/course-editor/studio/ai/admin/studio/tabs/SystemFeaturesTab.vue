...
<template>
  <div class="features-tab">
    ...
    <div v-if="!course" class="empty-state">
      ...
      <h3>{{ $t('features.aiEditorFeatures.selectCourse') }}</h3>
      <p>{{ $t('features.aiEditorFeatures.selectCourseDesc') }}</p>
    </div>
    ...
    <div v-else class="features-content">
      ...
      <div class="feature-groups">
        ...
        <FeatureGroup
          icon="🤖"
          :title="$t('features.aiEditorFeatures.groups.tutor.title')"
          :description="$t('features.aiEditorFeatures.groups.tutor.description')"
        ...
        >
          <FeatureToggle
            ...
            code="SF01"
            :label="$t('features.aiEditorFeatures.features.socraticDialog.label')"
            :description="$t('features.aiEditorFeatures.features.socraticDialog.description')"
            :token-cost="800"
          ...
          <FeatureToggle
            ...
            code="SF02"
            :label="$t('features.aiEditorFeatures.features.npcLecture.label')"
            :description="$t('features.aiEditorFeatures.features.npcLecture.description')"
            :token-cost="1200"
        ...
        <FeatureGroup
          icon="💻"
          :title="$t('features.aiEditorFeatures.groups.it.title')"
          :description="$t('features.aiEditorFeatures.groups.it.description')"
          :expanded="expandedGroups.has('it')"
          :group-enabled="isGroupEnabled('it')"
          :requirement-notice="$t('features.aiEditorFeatures.requiresDocker')"
        ...
        >
          <FeatureToggle
            ...
            code="SF03"
            :label="$t('features.aiEditorFeatures.features.codeSandbox.label')"
            :description="$t('features.aiEditorFeatures.features.codeSandbox.description')"
            :token-cost="500"
          ...
          <FeatureToggle
            ...
            code="SF04"
            :label="$t('features.aiEditorFeatures.features.networkSim.label')"
            :description="$t('features.aiEditorFeatures.features.networkSim.description')"
            :token-cost="600"
          ...
          <FeatureToggle
            ...
            code="SF05"
            :label="$t('features.aiEditorFeatures.features.itScenario.label')"
            :description="$t('features.aiEditorFeatures.features.itScenario.description')"
            :token-cost="700"
          ...
          <FeatureToggle
            ...
            code="SF06"
            :label="$t('features.aiEditorFeatures.features.errorAnalysis.label')"
            :description="$t('features.aiEditorFeatures.features.errorAnalysis.description')"
            :token-cost="400"
        ...
        <FeatureGroup
          icon="👥"
          :title="$t('features.aiEditorFeatures.groups.collab.title')"
          :description="$t('features.aiEditorFeatures.groups.collab.description')"
        ...
        >
          <FeatureToggle
            ...
            code="SF07"
            :label="$t('features.aiEditorFeatures.features.peerInstruction.label')"
            :description="$t('features.aiEditorFeatures.features.peerInstruction.description')"
            :token-cost="300"
          ...
          <FeatureToggle
            ...
            code="SF08"
            :label="$t('features.aiEditorFeatures.features.teamCase.label')"
            :description="$t('features.aiEditorFeatures.features.teamCase.description')"
            :token-cost="400"
          ...
          <FeatureToggle
            ...
            code="SF09"
            :label="$t('features.aiEditorFeatures.features.peerReview.label')"
            :description="$t('features.aiEditorFeatures.features.peerReview.description')"
            :token-cost="350"
          ...
          <FeatureToggle
            ...
            code="SF10"
            :label="$t('features.aiEditorFeatures.features.learningDiary.label')"
            :description="$t('features.aiEditorFeatures.features.learningDiary.description')"
            :token-cost="200"
          ...
          <FeatureToggle
            ...
            code="SF11"
            :label="$t('features.aiEditorFeatures.features.portfolio.label')"
            :description="$t('features.aiEditorFeatures.features.portfolio.description')"
            :token-cost="250"
          ...
          <FeatureToggle
            ...
            code="SF12"
            :label="$t('features.aiEditorFeatures.features.projectBased.label')"
            :description="$t('features.aiEditorFeatures.features.projectBased.description')"
            :token-cost="500"
          ...
          <FeatureToggle
            ...
            code="SF13"
            :label="$t('features.aiEditorFeatures.features.invertedClassroom.label')"
            :description="$t('features.aiEditorFeatures.features.invertedClassroom.description')"
            :token-cost="300"
        ...
        <FeatureGroup
          icon="🎨"
          :title="$t('features.aiEditorFeatures.groups.viz.title')"
          :description="$t('features.aiEditorFeatures.groups.viz.description')"
        ...
        >
          <FeatureToggle
            ...
            code="SF14"
            :label="$t('features.aiEditorFeatures.features.mindmap.label')"
            :description="$t('features.aiEditorFeatures.features.mindmap.description')"
            :token-cost="400"
...
import {
  ...
  FeatureToggle,
  ActionsBar
} from '@/components/studio/assessment/admin/settings/exams'
...
const scopeLabel = computed(() => {
  if (currentScope.value === 'lesson' && props.lesson) {
    return `${t('features.aiEditorFeatures.scopeLesson')}: ${props.lesson.title}`
  }
  if (currentScope.value === 'chapter' && props.chapter) {
    return `${t('features.aiEditorFeatures.scopeChapter')}: ${props.chapter.title}`
  }
  return t('features.aiEditorFeatures.scopeCourseGlobal')
})
