...
const availableScopes = computed(() => [
  { value: 'all', label: t('panel.prompts.scopes.all'), icon: '📋' },
  { value: 'course_generation', label: t('panel.prompts.types.courseGeneration'), icon: '📚' },
  { value: 'module_generation', label: t('panel.prompts.scopes.moduleGeneration'), icon: '📖' },
  { value: 'lesson_generation', label: t('panel.prompts.types.lessonGeneration'), icon: '📄' },
  { value: 'quiz_generation', label: t('panel.prompts.scopes.quizGeneration'), icon: '❓' },
  { value: 'exam_generation', label: t('panel.prompts.scopes.examGeneration'), icon: '📝' }
])
