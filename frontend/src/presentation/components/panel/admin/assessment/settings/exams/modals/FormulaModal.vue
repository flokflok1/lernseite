  ...
  >
    <div class="bg-[var(--color-surface)] rounded-xl p-6 w-[600px] max-h-[80vh] overflow-y-auto">
      <h3 class="text-lg font-semibold text-[var(--color-text-primary)] mb-4">
        {{ $t('aiEditorAssets.formulaModal.title') }}
      </h3>
      ...
      <div class="space-y-4">
        ...
        <div>
          <label class="text-sm text-[var(--color-text-secondary)] mb-1 block">
            {{ $t('aiEditorAssets.formulaModal.latexCode') }}
          </label>
          <textarea
            :value="modelValue"
            ...
            :placeholder="$t('aiEditorAssets.formulaModal.latexPlaceholder')"
          ></textarea>
        </div>
        ...
        <div>
          <label class="text-sm text-[var(--color-text-secondary)] mb-1 block">
            {{ $t('aiEditorAssets.formulaModal.preview') }}
          </label>
        ...
        <div>
          <label class="text-sm text-[var(--color-text-secondary)] mb-2 block">
            {{ $t('aiEditorAssets.formulaModal.commonFormulas') }}
          </label>
