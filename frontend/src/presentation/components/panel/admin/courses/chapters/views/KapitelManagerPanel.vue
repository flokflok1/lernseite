      ...
      <div v-if="currentView === 'list'" class="p-4">
        ...
        <div v-else-if="chapters.length === 0" class="text-center py-12">
          ...
          <h3 class="text-lg font-semibold text-[var(--color-text-primary)] mb-2">
            {{ $t('features.kapitelManager.noChapters') }}
          </h3>
          <p class="text-sm text-[var(--color-text-secondary)] mb-6 max-w-sm mx-auto">
            {{ $t('features.kapitelManager.createFirstHint') }}
          </p>
          <button
            @click="createManual"
          ...
          >
            {{ $t('features.kapitelManager.createFirst') }}
          </button>
        </div>
        ...
        <div class="max-w-xl mx-auto space-y-6">
          ...
          <div>
            ...
            <input
              ...
              :placeholder="$t('features.kapitelManager.titlePlaceholder')"
          ...
          <div>
            ...
            <textarea
              ...
              :placeholder="$t('features.kapitelManager.descriptionPlaceholder')"
            ></textarea>
          </div>
