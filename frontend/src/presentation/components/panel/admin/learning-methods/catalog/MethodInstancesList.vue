<!--
  MethodInstancesList - Displays the list of learning method instances
  with drag-and-drop reordering, edit, publish, and delete actions.
-->
      ...
      >
        <div class="flex items-start justify-between gap-3">
          ...
          <div class="flex gap-2 flex-shrink-0">
            ...
            <button
              @click="$emit('togglePublish', method)"
              class="p-1.5 rounded transition-colors"
            ...
            <button
              @click="$emit('delete', method.method_id)"
              class="p-1.5 rounded transition-colors"
...
defineEmits<{
  openSelector: []
  edit: [method: AdminLearningMethod]
  togglePublish: [method: AdminLearningMethod]
