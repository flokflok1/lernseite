...
export const LEARNING_METHOD_REGISTRY: Record<number, LearningMethodConfig> = {
  ...
  0: {
    ...
    tier: 'basic',
    kiUsage: 'medium',
    form: defineAsyncComponent(() => import('./editor/forms/DeepExplanationForm.vue'))
  },
  ...
  1: {
    ...
    tier: 'basic',
    kiUsage: 'medium',
    form: defineAsyncComponent(() => import('./editor/forms/InteractiveTheoryForm.vue'))
  },
  ...
  2: {
    ...
    tier: 'premium',
    kiUsage: 'intensive',
    form: defineAsyncComponent(() => import('./editor/forms/VisualStorytellingForm.vue'))
  },
  ...
  3: {
    ...
    tier: 'basic',
    kiUsage: 'medium',
    form: defineAsyncComponent(() => import('./editor/forms/DiagramVisualizationForm.vue'))
  },
  ...
  4: {
    ...
    tier: 'basic',
    kiUsage: 'medium',
    form: defineAsyncComponent(() => import('./editor/forms/StepByStepGuideForm.vue'))
  },
  ...
  5: {
    ...
    tier: 'basic',
    kiUsage: 'optional',
    form: defineAsyncComponent(() => import('./editor/forms/FillInTheBlanksForm.vue'))
  },
  ...
  6: {
    ...
    tier: 'basic',
    kiUsage: 'optional',
    form: defineAsyncComponent(() => import('./editor/forms/DragAndDropForm.vue'))
  },
  ...
  10: {
    ...
    tier: 'premium',
    kiUsage: 'intensive',
    form: defineAsyncComponent(() => import('./editor/forms/EssayExamForm.vue'))
  },
  ...
  11: {
    ...
    tier: 'premium',
    kiUsage: 'intensive',
    form: defineAsyncComponent(() => import('./editor/forms/FinalAssessmentForm.vue'))
  }
}
