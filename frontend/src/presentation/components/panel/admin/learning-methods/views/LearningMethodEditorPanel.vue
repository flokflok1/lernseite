...
// Computed
const tabs = computed(() => [
  { id: 'instances', label: t('panel.learningMethods.tabs.instances'), icon: '🎯' },
  { id: 'catalog', label: t('panel.learningMethods.tabs.catalog'), icon: '📖' },
  { id: 'stats', label: t('panel.learningMethods.tabs.stats'), icon: '📊' }
])
