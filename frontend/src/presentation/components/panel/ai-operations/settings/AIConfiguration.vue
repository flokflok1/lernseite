  ...
  <div class="ai-configuration">
    ...
    <div class="mb-6">
      <h3 class="text-xl font-semibold text-[var(--color-text-primary)] mb-2">
        {{ $t('panel.aiSettings.title', 'AI Provider Configuration') }}
      </h3>
      <p class="text-[var(--color-text-secondary)]">
        {{ $t('panel.aiSettings.description', 'Configure API keys for Claude and OpenAI, and synchronize available models') }}
      </p>
    </div>
