...
<template>
  <div class="lm-configuration">
    <h2>{{ $t('panel.learningMethods.title') }}</h2>
    ...
    <div class="config-info">
      <h3>{{ $t('panel.learningMethods.info') }}</h3>
      <div class="info-box">
        <p>
          <strong>{{ $t('panel.learningMethods.groupA') }}:</strong>
          {{ $t('panel.learningMethods.groupADesc') }}
        </p>
        <p>
          <strong>{{ $t('panel.learningMethods.groupB') }}:</strong>
          {{ $t('panel.learningMethods.groupBDesc') }}
        </p>
        <p>
          <strong>{{ $t('panel.learningMethods.groupC') }}:</strong>
          {{ $t('panel.learningMethods.groupCDesc') }}
        </p>
      </div>
    </div>
  </div>
