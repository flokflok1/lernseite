...
import type {
  ...
  QuickAction,
  LMSuggestion
} from '@/components/admin/ai-operations/authoring/course-builder/types'
```

### Direct Import (If Needed)

```typescript
import type { Session } from '@/components/admin/ai-operations/authoring/course-builder/types/session.types'
import type { Course } from '@/components/admin/ai-operations/authoring/course-builder/types/course.types'
```
