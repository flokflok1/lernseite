...
<template>
  <div class="features-tab">
    ...
    <div v-if="!course" class="empty-state">
      ...
      <h3>{{ $t('aiEditorFeatures.selectCourse') }}</h3>
      <p>{{ $t('aiEditorFeatures.selectCourseDesc') }}</p>
    </div>
    ...
    <div v-else class="features-content">
      ...
      <div class="feature-groups">
        ...
        <FeatureGroup
          icon="🤖"
          :title="$t('aiEditorFeatures.groups.tutor.title')"
          :description="$t('aiEditorFeatures.groups.tutor.description')"
        ...
        >
          <FeatureToggle
            ...
            code="SF01"
            :label="$t('aiEditorFeatures.features.socraticDialog.label')"
            :description="$t('aiEditorFeatures.features.socraticDialog.description')"
            :token-cost="800"
          ...
          <FeatureToggle
            ...
            code="SF02"
            :label="$t('aiEditorFeatures.features.npcLecture.label')"
            :description="$t('aiEditorFeatures.features.npcLecture.description')"
            :token-cost="1200"
        ...
        <FeatureGroup
          icon="💻"
          :title="$t('aiEditorFeatures.groups.it.title')"
          :description="$t('aiEditorFeatures.groups.it.description')"
          :expanded="expandedGroups.has('it')"
          :group-enabled="isGroupEnabled('it')"
          :requirement-notice="$t('aiEditorFeatures.requiresDocker')"
        ...
        >
          <FeatureToggle
            ...
            code="SF03"
            :label="$t('aiEditorFeatures.features.codeSandbox.label')"
            :description="$t('aiEditorFeatures.features.codeSandbox.description')"
            :token-cost="500"
          ...
          <FeatureToggle
            ...
            code="SF04"
            :label="$t('aiEditorFeatures.features.networkSim.label')"
            :description="$t('aiEditorFeatures.features.networkSim.description')"
            :token-cost="600"
          ...
          <FeatureToggle
            ...
            code="SF05"
            :label="$t('aiEditorFeatures.features.itScenario.label')"
            :description="$t('aiEditorFeatures.features.itScenario.description')"
            :token-cost="700"
          ...
          <FeatureToggle
            ...
            code="SF06"
            :label="$t('aiEditorFeatures.features.errorAnalysis.label')"
            :description="$t('aiEditorFeatures.features.errorAnalysis.description')"
            :token-cost="400"
        ...
        <FeatureGroup
          icon="👥"
          :title="$t('aiEditorFeatures.groups.collab.title')"
          :description="$t('aiEditorFeatures.groups.collab.description')"
        ...
        >
          <FeatureToggle
            ...
            code="SF07"
            :label="$t('aiEditorFeatures.features.peerInstruction.label')"
            :description="$t('aiEditorFeatures.features.peerInstruction.description')"
            :token-cost="300"
          ...
          <FeatureToggle
            ...
            code="SF08"
            :label="$t('aiEditorFeatures.features.teamCase.label')"
            :description="$t('aiEditorFeatures.features.teamCase.description')"
            :token-cost="400"
          ...
          <FeatureToggle
            ...
            code="SF09"
            :label="$t('aiEditorFeatures.features.peerReview.label')"
            :description="$t('aiEditorFeatures.features.peerReview.description')"
            :token-cost="350"
          ...
          <FeatureToggle
            ...
            code="SF10"
            :label="$t('aiEditorFeatures.features.learningDiary.label')"
            :description="$t('aiEditorFeatures.features.learningDiary.description')"
            :token-cost="200"
          ...
          <FeatureToggle
            ...
            code="SF11"
            :label="$t('aiEditorFeatures.features.portfolio.label')"
            :description="$t('aiEditorFeatures.features.portfolio.description')"
            :token-cost="250"
          ...
          <FeatureToggle
            ...
            code="SF12"
            :label="$t('aiEditorFeatures.features.projectBased.label')"
            :description="$t('aiEditorFeatures.features.projectBased.description')"
            :token-cost="500"
          ...
          <FeatureToggle
            ...
            code="SF13"
            :label="$t('aiEditorFeatures.features.invertedClassroom.label')"
            :description="$t('aiEditorFeatures.features.invertedClassroom.description')"
            :token-cost="300"
        ...
        <FeatureGroup
          icon="🎨"
          :title="$t('aiEditorFeatures.groups.viz.title')"
          :description="$t('aiEditorFeatures.groups.viz.description')"
        ...
        >
          <FeatureToggle
            ...
            code="SF14"
            :label="$t('aiEditorFeatures.features.mindmap.label')"
            :description="$t('aiEditorFeatures.features.mindmap.description')"
            :token-cost="400"
...
import {
  ...
  FeatureToggle,
  ActionsBar
} from '@/presentation/components/panel/admin/assessment/settings/exams'
...
const scopeLabel = computed(() => {
  if (currentScope.value === 'lesson' && props.lesson) {
    return `${t('aiEditorFeatures.scopeLesson')}: ${props.lesson.title}`
  }
  if (currentScope.value === 'chapter' && props.chapter) {
    return `${t('aiEditorFeatures.scopeChapter')}: ${props.chapter.title}`
  }
  return t('aiEditorFeatures.scopeCourseGlobal')
})
