<!--
  AI Studio Pro - Main orchestrator for AI-powered course authoring
  ...
  <div class="ai-studio-pro">
    ...
    <div class="tabs-bar">
      ...
      >
        ...
        <span class="tab-label">{{ $t('panel.aiStudio.chat') }}</span>
        <svg
          class="chat-chevron"
...
/**
 * AiStudioProWindow - Main orchestrator for AI Studio Pro
 */
...
const tabs = computed(() => [
  { id: 'builder', icon: '📚', label: t('panel.aiStudio.tabs.builder') },
  { id: 'tutor', icon: '🤖', label: t('panel.aiStudio.tabs.tutor') },
  { id: 'methods', icon: '🧩', label: t('panel.aiStudio.tabs.methods') },
  { id: 'exams', icon: '📝', label: t('panel.aiStudio.tabs.exams') },
  { id: 'features', icon: '🎛️', label: t('panel.aiStudio.tabs.features') },
  { id: 'prompts', icon: '📄', label: t('panel.aiStudio.tabs.prompts') },
  { id: 'analytics', icon: '📊', label: t('panel.aiStudio.tabs.analytics') },
  { id: 'settings', icon: '⚙️', label: t('panel.aiStudio.tabs.settings') },
  { id: 'global', icon: '🌐', label: t('panel.aiStudio.tabs.global') }
])
