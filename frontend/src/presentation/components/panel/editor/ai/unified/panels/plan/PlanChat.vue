...
<template>
  <div class="flex flex-col border border-gray-700 rounded-lg bg-gray-900/50">
    ...
    <div class="flex gap-2 p-2 border-t border-gray-700">
      <button
        v-if="canUndo"
        class="px-2 py-1.5 text-sm text-yellow-400 hover:text-yellow-300 bg-yellow-900/20 hover:bg-yellow-900/40 border border-yellow-800/50 rounded transition-colors"
        :title="t('aiEditor.planWizard.undo')"
        @click="emit('undo')"
      >
        ↩
      </button>
