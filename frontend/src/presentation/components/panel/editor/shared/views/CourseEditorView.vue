...
const { t } = useI18n()
import CourseMetaForm from '@/presentation/components/panel/editor/manual/panels/course/CourseMetaForm.vue'
import ModuleLessonTree from '@/presentation/components/panel/editor/manual/panels/structure/ChapterLessonTree.vue'
import LessonContentEditor from '@/presentation/components/panel/editor/manual/panels/lesson/LessonContentEditor.vue'
