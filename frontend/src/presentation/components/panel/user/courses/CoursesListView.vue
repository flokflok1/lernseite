...
import CourseCard from '@/presentation/components/panel/user/courses/CourseCard.vue'
import EnrolledCourseCard from '@/presentation/components/panel/user/courses/EnrolledCourseCard.vue'
