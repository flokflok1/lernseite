...
import CourseCard from '@/presentation/components/panel/user/courses/list/CourseCard.vue'
import EnrolledCourseCard from '@/presentation/components/panel/user/courses/list/EnrolledCourseCard.vue'
