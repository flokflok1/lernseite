...
import RpgCharacterCard from '@/presentation/components/panel/user/gamification/RpgCharacterCard.vue'
import RpgQuestList from '@/presentation/components/panel/user/gamification/RpgQuestList.vue'
import RpgSkillTree from '@/presentation/components/panel/user/gamification/RpgSkillTree.vue'
import RpgInventorySummary from '@/presentation/components/panel/user/gamification/RpgInventorySummary.vue'

import DashboardSkeleton from '@/presentation/components/panel/user/dashboard/DashboardSkeleton.vue'
import DashboardCoursesTab from '@/presentation/components/panel/user/dashboard/DashboardCoursesTab.vue'
import DashboardProgressWidget from '@/presentation/components/panel/user/dashboard/DashboardProgressWidget.vue'
