    ...
    <div class="main-layout">
      ...
      <div class="list-panel">
        <div class="panel-header">
          ...
          <button @click="loadTheories" class="refresh-btn" :title="$t('chapterTheoryView.refresh')">🔄</button>
        </div>
        ...
        <div v-else class="content-list">
          ...
          >
            ...
            <div class="item-actions">
              <button v-if="theory.audioUrl" @click.stop="playAudio(theory.audioUrl)" class="item-btn" :title="$t('chapterTheoryView.playAudio')">
                🔊
              </button>
              <button @click.stop="onDeleteTheory(theory.theoryId)" class="item-btn danger" :title="$t('chapterTheoryView.delete')">🗑️</button>
            </div>
          </div>
        </div>
      ...
      <div class="detail-panel">
        ...
        <div v-if="showCreateForm" class="create-form">
          <div class="form-section">
            ...
            <input v-model="newTitle" type="text" class="form-input" :placeholder="$t('chapterTheoryView.titlePlaceholder')" />
          </div>
          ...
          <div class="settings-section">
            ...
            <div class="setting-row">
              ...
              <button @click="tts.toggleTTS()" class="toggle-btn" :class="{ active: tts.ttsEnabled.value }">
                {{ tts.ttsEnabled.value ? $t('chapterTheoryView.tts.on') : $t('chapterTheoryView.tts.off') }}
              </button>
            </div>
            <div class="setting-row">
