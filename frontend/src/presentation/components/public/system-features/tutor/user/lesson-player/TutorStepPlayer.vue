...
import TutorStepCard from './TutorStepCard.vue'
import TutorPlayerNavigation from './TutorPlayerNavigation.vue'
...
.tutor-info { flex: 1; display: flex; flex-direction: column; }
...
.tutor-status.speaking { color: #10b981; }

.tutor-controls { display: flex; align-items: center; gap: 0.5rem; }
...
.tts-select:hover { border-color: var(--color-primary, #6366f1); }
.tts-select:focus { outline: none; border-color: var(--color-primary, #6366f1); }
.voice-select { min-width: 90px; }
...
@media (min-width: 900px) {
  .tutor-main-area { flex-direction: row; align-items: flex-start; }
  .tutor-main-area .whiteboard-container { flex: 0 0 500px; }
  .tutor-main-area :deep(.step-card) { flex: 1; }
}
