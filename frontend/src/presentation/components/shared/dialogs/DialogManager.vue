...
import PreviewCourseEditor from '../previews/PreviewCourseEditor.vue'
import PreviewKapitelEditor from '../previews/PreviewKapitelEditor.vue'
import PreviewLessonEditor from '../previews/PreviewLessonEditor.vue'
import PreviewAIJob from '../previews/PreviewAIJob.vue'
...
function getWindowTypeLabel(type: WindowType): string {
  const keyMap: Record<WindowType, string> = {
