  ...
  >
    <template #method-fields="{ form }">
      ...
      <div>
        <label class="block text-sm font-medium text-[var(--color-text-primary)] mb-2">
          {{ $t('features.lm03.diagramTitleLabel') }}
        </label>
        <input
          v-model="methodData.diagram_title"
          type="text"
          :placeholder="t('features.lm03.diagramTitlePlaceholder')"
      ...
      <div>
        <label class="block text-sm font-medium text-[var(--color-text-primary)] mb-2">
          {{ $t('features.lm03.diagramTypeLabel') }}
        </label>
        <select
          ...
          required
        >
          <option value="">{{ $t('features.lm03.diagramTypeDefault') }}</option>
          <option value="flowchart">{{ $t('features.lm03.diagramTypeFlowchart') }}</option>
          <option value="network">{{ $t('features.lm03.diagramTypeNetwork') }}</option>
          <option value="uml_class">{{ $t('features.lm03.diagramTypeUmlClass') }}</option>
          <option value="uml_sequence">{{ $t('features.lm03.diagramTypeUmlSequence') }}</option>
          <option value="uml_usecase">{{ $t('features.lm03.diagramTypeUmlUsecase') }}</option>
          <option value="er_diagram">{{ $t('features.lm03.diagramTypeErDiagram') }}</option>
          <option value="hierarchy">{{ $t('features.lm03.diagramTypeHierarchy') }}</option>
          <option value="timeline">{{ $t('features.lm03.diagramTypeTimeline') }}</option>
          <option value="process">{{ $t('features.lm03.diagramTypeProcess') }}</option>
          <option value="architecture">{{ $t('features.lm03.diagramTypeArchitecture') }}</option>
          <option value="other">{{ $t('features.lm03.diagramTypeOther') }}</option>
        </select>
      </div>
      ...
      <div>
        <label class="block text-sm font-medium text-[var(--color-text-primary)] mb-2">
          {{ $t('features.lm03.descriptionLabel') }}
        </label>
        <textarea
          v-model="methodData.description"
          rows="3"
          :placeholder="t('features.lm03.descriptionPlaceholder')"
      ...
      <div>
        <label class="block text-sm font-medium text-[var(--color-text-primary)] mb-2">
          {{ $t('features.lm03.diagramCodeLabel') }}
        </label>
        <textarea
    ...
    D --> E"
        ...
        <p class="mt-1 text-xs text-[var(--color-text-secondary)]">
          {{ $t('features.lm03.diagramCodeHint') }}
        </p>
      </div>
      ...
      <div>
        <div class="flex items-center justify-between mb-2">
          ...
          >
            {{ $t('features.lm03.addElement') }}
          </button>
        </div>

        <p class="text-xs text-[var(--color-text-secondary)] mb-2">
          {{ $t('features.lm03.elementsHint') }}
        </p>
        ...
        <div v-for="(element, index) in methodData.elements" :key="index" class="mb-2 flex gap-2">
          <input
            ...
            type="text"
            :placeholder="t('features.lm03.elementNamePlaceholder')"
          ...
          <input
            ...
            type="text"
            :placeholder="t('features.lm03.elementDescriptionPlaceholder')"
      ...
      <div>
        <label class="block text-sm font-medium text-[var(--color-text-primary)] mb-2">
          {{ $t('features.lm03.learningGoalLabel') }}
        </label>
        <input
          v-model="methodData.learning_goal"
          type="text"
          :placeholder="t('features.lm03.learningGoalPlaceholder')"
          class="w-full px-3 py-2 border border-[var(--color-border)] rounded-lg bg-[var(--color-surface)] text-[var(--color-text-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
        />
      </div>
    </template>
