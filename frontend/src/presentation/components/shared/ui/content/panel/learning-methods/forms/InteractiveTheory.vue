    ...
    <template #method-fields="{ form }">
      ...
      <div>
        <label class="block text-sm font-medium text-[var(--color-text-primary)] mb-2">
          {{ $t('features.learningMethods.lm02.topicLabel') }}
        </label>
        <input
          v-model="methodData.topic"
          type="text"
          :placeholder="$t('features.learningMethods.lm02.topicPlaceholder')"
      ...
      <div>
        <div class="flex items-center justify-between mb-2">
          <label class="block text-sm font-medium text-[var(--color-text-primary)]">
            {{ $t('features.learningMethods.lm02.sectionsLabel') }}
          </label>
          <button
            @click="addSection"
            type="button"
        ...
        <div v-for="(section, index) in methodData.sections" :key="index" class="mb-4 p-4 border border-[var(--color-border)] rounded-lg bg-[var(--color-surface-secondary)]">
          <div class="flex items-center justify-between mb-3">
            <span class="text-sm font-bold text-[var(--color-primary)]">
              {{ $t('features.learningMethods.lm02.sectionNumber', { n: index + 1 }) }}
            </span>
            <button
            ...
            >
              {{ $t('features.learningMethods.lm02.removeSection') }}
            </button>
          </div>
          ...
          <div class="space-y-3">
            ...
            <div>
              <label class="block text-xs font-medium text-[var(--color-text-secondary)] mb-1">
                {{ $t('features.learningMethods.lm02.sectionTitleLabel') }}
              </label>
              <input
                v-model="section.title"
                type="text"
                :placeholder="$t('features.learningMethods.lm02.sectionTitlePlaceholder')"
                class="w-full px-3 py-2 border border-[var(--color-border)] rounded-lg bg-[var(--color-surface)] text-[var(--color-text-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
              />
            </div>
            ...
            <div>
              <label class="block text-xs font-medium text-[var(--color-text-secondary)] mb-1">
                {{ $t('features.learningMethods.lm02.theoryLabel') }}
              </label>
              <textarea
                v-model="section.theory"
                rows="4"
                :placeholder="$t('features.learningMethods.lm02.theoryPlaceholder')"
            ...
            <div class="border-t border-[var(--color-border)] pt-3 mt-3">
              <label class="block text-xs font-medium text-[var(--color-text-secondary)] mb-1">
                {{ $t('features.learningMethods.lm02.questionLabel') }}
              </label>
              <input
                v-model="section.question"
                type="text"
                :placeholder="$t('features.learningMethods.lm02.questionPlaceholder')"
                class="w-full px-3 py-2 border border-[var(--color-border)] rounded-lg bg-[var(--color-surface)] text-[var(--color-text-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                required
              />
            </div>
            ...
            <div>
              <label class="block text-xs font-medium text-[var(--color-text-secondary)] mb-1">
                {{ $t('features.learningMethods.lm02.answerLabel') }}
              </label>
              <input
                v-model="section.expected_answer"
                type="text"
                :placeholder="$t('features.learningMethods.lm02.answerPlaceholder')"
                class="w-full px-3 py-2 border border-[var(--color-border)] rounded-lg bg-[var(--color-surface)] text-[var(--color-text-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
              />
            </div>
          </div>
      ...
      <div>
        <label class="block text-sm font-medium text-[var(--color-text-primary)] mb-2">
          {{ $t('features.learningMethods.lm02.finalQuestionLabel') }}
        </label>
        <textarea
          v-model="methodData.final_question"
          rows="2"
          :placeholder="$t('features.learningMethods.lm02.finalQuestionPlaceholder')"
          class="w-full px-3 py-2 border border-[var(--color-border)] rounded-lg bg-[var(--color-surface)] text-[var(--color-text-primary)] resize-none focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
        />
      </div>
    </template>
