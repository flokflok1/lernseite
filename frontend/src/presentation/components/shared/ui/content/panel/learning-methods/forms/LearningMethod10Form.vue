      ...
      <div class="space-y-4">
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            {{ $t('features.lm10.title') }}
          </label>
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">
            {{ $t('features.lm10.description') }}
          </p>
        </div>

        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            {{ $t('features.lm10.instructionLabel') }}
          </label>
          <textarea
            v-model="methodData.instruction"
            rows="3"
            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
            :placeholder="$t('features.lm10.instructionPlaceholder')"
            required
          ></textarea>
        </div>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            {{ $t('features.lm10.networkTypeLabel') }}
          </label>
          <select
            ...
            required
          >
            <option value="">{{ $t('features.lm10.networkTypeDefault') }}</option>
            <option value="lan">{{ $t('features.lm10.networkTypeLan') }}</option>
            <option value="wan">{{ $t('features.lm10.networkTypeWan') }}</option>
            <option value="vlan">{{ $t('features.lm10.networkTypeVlan') }}</option>
            <option value="routing">{{ $t('features.lm10.networkTypeRouting') }}</option>
            <option value="firewall">{{ $t('features.lm10.networkTypeFirewall') }}</option>
            <option value="vpn">{{ $t('features.lm10.networkTypeVpn') }}</option>
            <option value="wifi">{{ $t('features.lm10.networkTypeWifi') }}</option>
          </select>
        </div>

        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            {{ $t('features.lm10.componentsLabel') }}
          </label>
          <div class="grid grid-cols-2 gap-2">
            <label v-for="comp in availableComponents" :key="comp.id" class="flex items-center space-x-2">
              ...
              />
              <span class="text-sm text-gray-700 dark:text-gray-300">{{ $t(`features.lm10.component_${comp.id}`) }}</span>
            </label>
          </div>
        </div>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            {{ $t('features.lm10.topologyLabel') }}
          </label>
          <textarea
            v-model="methodData.expected_topology"
            rows="4"
            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
            :placeholder="$t('features.lm10.topologyPlaceholder')"
            required
          ></textarea>
        </div>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            {{ $t('features.lm10.ipRangeLabel') }}
          </label>
          <input
            v-model="methodData.ip_range"
            type="text"
            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
            :placeholder="$t('features.lm10.ipRangePlaceholder')"
          />
        </div>
        ...
        <div>
          <label class="flex items-center space-x-2">
            ...
            <span class="text-sm text-gray-700 dark:text-gray-300">
              {{ $t('features.lm10.connectivityLabel') }}
            </span>
          </label>
        </div>
      </div>
