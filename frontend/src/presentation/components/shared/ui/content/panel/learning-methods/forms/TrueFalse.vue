      ...
      <div class="space-y-6">
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            {{ $t('features.learningMethods.lm11.title') }}
          </label>
          <p class="text-sm text-gray-500 dark:text-gray-400">
            {{ $t('features.learningMethods.lm11.description') }}
          </p>
        </div>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
            {{ $t('features.learningMethods.lm11.statementsLabel') }}
          </label>
            ...
            >
              <div class="flex items-start space-x-3 mb-3">
                ...
                <div class="flex-1">
                  <textarea
                    ...
                    :placeholder="$t('features.learningMethods.lm11.statementPlaceholder')"
                    required
                  ></textarea>
                </div>
                <button
              ...
              <div class="flex items-center space-x-4 ml-11">
                <label class="flex items-center space-x-2 cursor-pointer">
                  ...
                  <span class="text-sm text-gray-700 dark:text-gray-300">
                    {{ $t('features.learningMethods.lm11.optionTrue') }}
                  </span>
                </label>
                <label class="flex items-center space-x-2 cursor-pointer">
                  <input
                  ...
                  />
                  <span class="text-sm text-gray-700 dark:text-gray-300">
                    {{ $t('features.learningMethods.lm11.optionFalse') }}
                  </span>
                </label>
              </div>
              ...
              <div class="mt-3 ml-11">
                <input
                  ...
                  :placeholder="$t('features.learningMethods.lm11.explanationPlaceholder')"
                />
              </div>
            </div>
          </div>
          ...
          <div v-else class="p-6 bg-gray-50 dark:bg-gray-800 rounded-lg text-center text-sm text-gray-500 dark:text-gray-400">
            {{ $t('features.learningMethods.lm11.noStatements') }}
          </div>
          ...
          >
            {{ $t('features.learningMethods.lm11.addStatement') }}
          </button>
        </div>
        ...
        <div class="space-y-3">
          ...
          <label class="flex items-center space-x-2">
            ...
            />
            <span class="text-sm text-gray-700 dark:text-gray-300">
              {{ $t('features.learningMethods.lm11.randomizeLabel') }}
            </span>
          </label>
          ...
          <label class="flex items-center space-x-2">
            ...
            />
            <span class="text-sm text-gray-700 dark:text-gray-300">
              {{ $t('features.learningMethods.lm11.showExplanationsLabel') }}
            </span>
          </label>
        </div>
      </div>
