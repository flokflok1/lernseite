<template>
  <div class="system-info-widget bg-[#1a1f35] rounded-lg p-6">
    <h3 class="text-lg font-semibold text-white mb-4">
      {{ $t('panel.systemSettings.systemInfo') }}
    </h3>
    ...
    <div class="mb-6">
      <div class="flex items-center gap-3">
        <span class="text-sm text-gray-400">
          {{ $t('panel.systemSettings.currentEnvironment') }}:
        </span>
        <span
          :class="[
    ...
    <div class="grid grid-cols-2 gap-4 mb-6">
      ...
      <div class="bg-[#0f1419] rounded-lg p-4">
        <div class="flex items-center gap-2 mb-2">
          ...
          <span class="text-xs text-gray-400">
            {{ $t('panel.systemSettings.version') }}
          </span>
        </div>
      ...
      <div class="bg-[#0f1419] rounded-lg p-4">
        <div class="flex items-center gap-2 mb-2">
          ...
          <span class="text-xs text-gray-400">
            {{ $t('panel.systemSettings.database') }}
          </span>
        </div>
    ...
    <div class="mb-6">
      <h4 class="text-sm font-semibold text-gray-300 mb-3">
        {{ $t('panel.systemSettings.activeFeatures') }}
      </h4>
      <div class="space-y-2">
