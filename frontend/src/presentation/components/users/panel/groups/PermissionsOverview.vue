...
import { fetchPermissionsRegistry } from '@/infrastructure/api/clients/admin/groups.api'
import type { RegistryPermission } from '@/presentation/components/panel/groups/types'
