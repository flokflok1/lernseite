...
const { t } = useI18n()
import CourseMetaForm from '@/presentation/components/base/content/admin/editor/CourseMetaForm.vue'
import ModuleLessonTree from '@/presentation/components/base/content/admin/editor/ChapterLessonTree.vue'
import LessonContentEditor from '@/presentation/components/base/content/admin/editor/LessonContentEditor.vue'
