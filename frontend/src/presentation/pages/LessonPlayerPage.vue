...
import { MethodExecutionPanel } from '@/presentation/components/learning/methods'
...
const lessonComponents = {
  text: defineAsyncComponent(() => import('@/presentation/components/learning/methods/TextLesson.vue')),
  video: defineAsyncComponent(() => import('@/presentation/components/learning/methods/VideoLesson.vue')),
  quiz: defineAsyncComponent(() => import('@/presentation/components/learning/methods/quiz/QuizLesson.vue')),
  ai: defineAsyncComponent(() => import('@/presentation/components/learning/methods/AiLesson.vue')),
  interactive: defineAsyncComponent(() => import('@/presentation/components/learning/methods/AiLesson.vue')), // Interactive lessons
  mixed: defineAsyncComponent(() => import('@/presentation/components/learning/methods/TextLesson.vue')) // Fallback
}
