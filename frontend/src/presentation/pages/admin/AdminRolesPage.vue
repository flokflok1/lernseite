 ...
 * Uses sub-components from components/admin/user-management/roles/
 */
...
import {
  ...
  useRolesManagement,
  type RoleFormData
} from '@/presentation/components/users/admin/roles'
import type { Role } from '@/infrastructure/api/admin/roles.api'
