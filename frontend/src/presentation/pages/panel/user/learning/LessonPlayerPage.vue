...
const lessonComponents = {
  ...
  interactive: defineAsyncComponent(() => import('@/presentation/components/public/learning/methods/AiLesson.vue')), // Interactive lessons
  mixed: defineAsyncComponent(() => import('@/presentation/components/public/learning/methods/TextLesson.vue')) // Fallback
}
